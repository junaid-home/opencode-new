...
import type {
  ...
  GlobalFileCreateErrors,
  GlobalFileCreateResponses,
  GlobalHealthErrors,
  GlobalHealthResponses,
  GlobalPreviewHeartbeatErrors,
  GlobalPreviewHeartbeatResponses,
  GlobalPreviewStartErrors,
  GlobalPreviewStartResponses,
  GlobalPreviewStatusErrors,
  GlobalPreviewStatusResponses,
  GlobalPreviewStopErrors,
  GlobalPreviewStopResponses,
  GlobalUpgradeErrors,
...
export class Auth extends HeyApiClient {
  ...
  public signup<ThrowOnError extends boolean = false>(
    ...
    return (options?.client ?? this.client).post<AuthSignupResponses, AuthSignupErrors, ThrowOnError>({
      url: "/auth/signup",
      ...options,
      ...params,
      headers: {
  ...
  public me<ThrowOnError extends boolean = false>(options?: Options<never, ThrowOnError>) {
    return (options?.client ?? this.client).get<AuthMeResponses, AuthMeErrors, ThrowOnError>({
      url: "/auth/me",
      ...options,
    })
  }
...
export class File extends HeyApiClient {
  /**
   * Create directory, optionally extract a zip, and initialize git
   *
  ...
  public create<ThrowOnError extends boolean = false>(
    parameters?: {
      path?: string
      data?: Array<number | "NaN" | "Infinity" | "-Infinity" | "Infinity" | "-Infinity" | "NaN">
    },
    options?: Options<never, ThrowOnError>,
  ) {
    const params = buildClientParams(
    ...
    return (options?.client ?? this.client).post<GlobalFileCreateResponses, GlobalFileCreateErrors, ThrowOnError>({
      url: "/global/file/create",
      ...options,
      ...params,
      headers: {
        "Content-Type": "application/json",
...
export class Preview extends HeyApiClient {
   ...
   *
   * Auto-detect project type and start the dev server for preview.
   */
  public start<ThrowOnError extends boolean = false>(
    ...
    return (options?.client ?? this.client).post<GlobalPreviewStartResponses, GlobalPreviewStartErrors, ThrowOnError>({
      url: "/global/preview/start",
      ...options,
      ...params,
      headers: {
        "Content-Type": "application/json",
   ...
   *
   * Stop the running dev server for the current project.
   */
  public stop<ThrowOnError extends boolean = false>(
    ...
    const params = buildClientParams([parameters], [{ args: [{ in: "body", key: "directory" }] }])
    return (options?.client ?? this.client).post<GlobalPreviewStopResponses, GlobalPreviewStopErrors, ThrowOnError>({
      url: "/global/preview/stop",
      ...options,
      ...params,
      headers: {
        "Content-Type": "application/json",
   ...
   * Get preview status
   *
   * Get the current status of the dev server for the current project.
   */
  public status<ThrowOnError extends boolean = false>(options?: Options<never, ThrowOnError>) {
    return (options?.client ?? this.client).get<GlobalPreviewStatusResponses, GlobalPreviewStatusErrors, ThrowOnError>({
      url: "/global/preview/status",
      ...options,
    })
  }

  /**
   * Keep preview dev server alive
   *
   * Refresh the idle lease for the running dev server so it stays alive while the project is active.
   */
...
export class File2 extends HeyApiClient {
  ...
  public download<ThrowOnError extends boolean = false>(
    ...
    return (options?.client ?? this.client).post<FileDownloadResponses, FileDownloadErrors, ThrowOnError>({
      url: "/file/download",
      ...options,
      ...params,
      headers: {
...
export class Mcp extends HeyApiClient {
  ...
  /**
   * Remove an MCP server from runtime state.
   */
  public remove<ThrowOnError extends boolean = false>(
    parameters: {
      name: string
