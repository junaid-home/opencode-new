          ...
          <ModelList
            ...
            action={
              <div class="flex items-center gap-1">
                <Tooltip placement="top" value={language.t("dialog.model.select.title")}>
                  <IconButton
                    icon="plus-small"
                    variant="ghost"
                    iconSize="normal"
...
export function ModelSelectorPopoverV2(props: {
  ...
  const connectProvider = () => {
    ...
    afterClose(() => {
      void import("./dialog-connect-provider").then((x) => {
        dialog.show(() => <x.DialogConnectProvider />)
      })
    })
  }
  const openFullDialog = () => {
  ...
  const selectActive = () => {
    ...
    if (store.active === manageKey) connectProvider()
  }
        ...
        >
          <div class="flex flex-col p-0.5">
            <div class="flex h-7 items-center gap-2 rounded-sm pl-3 pr-2.5 text-v2-icon-icon-muted">
              ...
              <TooltipV2 placement="top" gutter={4} value={language.t("dialog.model.select.title")}>
                <button
                  type="button"
                  class="flex size-5 items-center justify-center rounded-sm text-v2-icon-icon-muted hover:bg-v2-overlay-simple-overlay-hover"
                  onClick={openFullDialog}
