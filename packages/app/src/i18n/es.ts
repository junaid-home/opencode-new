export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Modelos gratuitos proporcionados por O M A I +",
  ...
  "provider.connect.apiKey.description":
    "Introduce tu clave API de {{provider}} para conectar tu cuenta y usar modelos de {{provider}} en O M A I +.",
  ...
  "provider.connect.opencodeZen.line1":
    "O M A I + Zen te da acceso a un conjunto curado de modelos fiables optimizados para agentes de programación.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " para obtener tu código de autorización para conectar tu cuenta y usar modelos de {{provider}} en O M A I +.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e introduce el código a continuación para conectar tu cuenta y usar modelos de {{provider}} en O M A I +.",
  ...
  "session.question.pendingAnswer": "Por favor, responde las preguntas",
  ...
  "dialog.mcp.hint": "El estado del servidor MCP se muestra en el indicador de estado de sesión cuando se abre un proyecto.",
  ...
  "dialog.server.description": "Cambiar a qué servidor de O M A I + se conecta esta app.",
  ...
  "wsl.onboarding.checkingOpencode": "Comprobando O M A I +...",
  "wsl.onboarding.checkingOpencodeIn": "Comprobando O M A I + en {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Actualizando O M A I +...",
  "wsl.onboarding.updatingOpencodeIn": "Actualizando O M A I + en {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Actualiza O M A I + en {{distro}}.",
  "wsl.onboarding.updateOpencode": "Actualizar O M A I +",
  "wsl.onboarding.opencodeReadyIn": "O M A I + está listo en {{distro}}.",
  "wsl.onboarding.opencodeReady": "O M A I + está listo.",
  "wsl.onboarding.installOpencodeIn": "Instala O M A I + en {{distro}}.",
  "wsl.onboarding.installOpencode": "Instalar O M A I +",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "O M A I + no está instalado",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Se necesita WSL (Subsistema de Windows para Linux) para que O M A I + pueda añadir un servidor WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL no disponible",
  "wsl.onboarding.wslUnavailable.description": "O M A I + no pudo comprobar WSL en este equipo.",
  "wsl.onboarding.installWsl": "Instalar WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Reinicia Windows para terminar de instalar WSL y, después, vuelve a abrir O M A I +.",
  ...
  "toast.update.description": "Una nueva versión de O M A I + ({{version}}) está disponible para instalar.",
  ...
  "error.page.report.prefix": "Por favor reporta este error al equipo de O M A I +",
  ...
  "error.chain.mcpFailed": 'El servidor MCP "{{name}}" falló. Nota, O M A I + no soporta autenticación MCP todavía.',
  ...
  "sidebar.gettingStarted.line1": "O M A I + incluye modelos gratuitos para que puedas empezar inmediatamente.",
  ...
  "settings.desktop.wsl.description": "Ejecutar el servidor O M A I + dentro de WSL en Windows.",
  ...
  "settings.general.row.language.description": "Cambiar el idioma de visualización para O M A I +",
  ...
  "settings.general.row.appearance.description": "Personaliza cómo se ve O M A I + en tu dispositivo",
  "settings.general.row.colorScheme.title": "Esquema de color",
  "settings.general.row.colorScheme.description": "Elige si O M A I + sigue el tema del sistema, claro u oscuro",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personaliza el tema de O M A I +.",
  ...
  "settings.updates.row.startup.description": "Buscar actualizaciones automáticamente cuando se inicia O M A I +",
  ...
  "settings.updates.toast.latest.description": "Estás usando la última versión de O M A I +.",
  ...
  "session.question.custom.placeholder": "Escribe una respuesta personalizada...",
  ...
  "preview.starting": "Iniciando vista previa...",
  "preview.loading": "Cargando vista previa...",
  "preview.title": "Vista previa",

  "preview.error.loadFailed": "Error al cargar la vista previa.",
  "preview.action.reload": "Recargar",
  "preview.action.reloadPreview": "Recargar vista previa",
  "preview.action.openInBrowser": "Abrir en el navegador",
  "dialog.createProject.title": "Crear proyecto",
  "dialog.createProject.creating": "Creando proyecto...",
  "dialog.createProject.nameLabel": "Nombre del proyecto",
  "dialog.createProject.namePlaceholder": "mi-proyecto",
  "dialog.createProject.nameHint": "Solo letras, números, guiones y guiones bajos. Sin espacios.",
  "dialog.createProject.nameRequired": "Por favor, ingrese un nombre de proyecto",
  "dialog.createProject.duplicate": 'Ya existe un proyecto en "{{path}}"',
  "dialog.createProject.zipLabel": "Crear desde carpeta Zip (opcional)",
  "dialog.createProject.zipDropzone": "Suelte el archivo zip aquí o haga clic para explorar",
  "dialog.createProject.zipMaxSize": "Tamaño máximo del zip: 200MB",
  "dialog.createProject.zipTooLarge": "El archivo zip debe ser menor a {{size}}MB",
  "dialog.createProject.step.directory": "Creando directorio del proyecto...",
  "dialog.createProject.step.git": "Inicializando repositorio git...",
  "dialog.createProject.step.zip": "Extrayendo archivo zip...",
  "dialog.createProject.step.opening": "Abriendo proyecto...",
  "dialog.createProject.step.cleanup": "Limpiando...",
  "dialog.createProject.error.zipExtract": "Error al extraer archivo zip",
  "dialog.createProject.error.createFailed": "Error al crear proyecto",
  "session.panel.collapseToReview": "Contraer para revisar",
  "session.panel.restoreSplitView": "Restaurar vista dividida",
  "allProjects.view.grid": "Vista de cuadrícula",
  "allProjects.view.list": "Vista de lista",
  "auth.login.stealthMode": "MODO SIGILOSO",
  "session.prompt.disclaimer": "O M A I + es IA y puede cometer errores. Comprueba las respuestas.",
}
