export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Darmowe modele dostarczane przez O M A I +",
  ...
  "provider.connect.apiKey.description":
    "Wprowadź swój klucz API {{provider}}, aby połączyć konto i używać modeli {{provider}} w O M A I +.",
  ...
  "provider.connect.opencodeZen.line1":
    "O M A I + Zen daje dostęp do wybranego zestawu niezawodnych, zoptymalizowanych modeli dla agentów kodujących.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    ", aby odebrać kod autoryzacyjny, połączyć konto i używać modeli {{provider}} w O M A I +.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i wprowadź poniższy kod, aby połączyć konto i używać modeli {{provider}} w O M A I +.",
  ...
  "session.question.pendingAnswer": "Odpowiedz proszę na pytania",
  ...
  "dialog.mcp.empty": "Nie skonfigurowano MCP",
  "dialog.mcp.hint": "Status serwera MCP jest wyświetlany w wskaźniku statusu sesji, gdy otwarty jest projekt.",
  ...
  "dialog.server.description": "Przełącz serwer O M A I +, z którym łączy się ta aplikacja.",
  ...
  "wsl.onboarding.checkingOpencode": "Sprawdzanie O M A I +...",
  "wsl.onboarding.checkingOpencodeIn": "Sprawdzanie O M A I + w dystrybucji {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Aktualizowanie O M A I +...",
  "wsl.onboarding.updatingOpencodeIn": "Aktualizowanie O M A I + w dystrybucji {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Zaktualizuj O M A I + w dystrybucji {{distro}}.",
  "wsl.onboarding.updateOpencode": "Zaktualizuj O M A I +",
  "wsl.onboarding.opencodeReadyIn": "O M A I + jest gotowy w dystrybucji {{distro}}.",
  "wsl.onboarding.opencodeReady": "O M A I + jest gotowy.",
  "wsl.onboarding.installOpencodeIn": "Zainstaluj O M A I + w dystrybucji {{distro}}.",
  "wsl.onboarding.installOpencode": "Zainstaluj O M A I +",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "O M A I + nie jest zainstalowany",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Podsystem Windows dla systemu Linux) jest wymagany, zanim O M A I + będzie mógł dodać serwer WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL jest niedostępny",
  "wsl.onboarding.wslUnavailable.description": "O M A I + nie mógł zweryfikować WSL na tym komputerze.",
  "wsl.onboarding.installWsl": "Zainstaluj WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Uruchom ponownie system Windows, aby dokończyć instalację WSL, a następnie ponownie otwórz O M A I +.",
  ...
  "toast.update.description": "Nowa wersja O M A I + ({{version}}) jest teraz dostępna do instalacji.",
  ...
  "error.page.report.prefix": "Proszę zgłosić ten błąd do zespołu O M A I +",
  ...
  "error.chain.mcpFailed":
    "Serwer MCP „{{name}}” nie uruchomił się. Uwaga: O M A I + nie obsługuje jeszcze uwierzytelniania MCP.",
  ...
  "sidebar.gettingStarted.line1": "O M A I + zawiera darmowe modele, więc możesz zacząć od razu.",
  ...
  "settings.desktop.wsl.description": "Uruchamiaj serwer O M A I + wewnątrz WSL w systemie Windows.",
  ...
  "settings.general.row.language.description": "Zmień język wyświetlania dla O M A I +",
  ...
  "settings.general.row.appearance.description": "Dostosuj wygląd O M A I + na swoim urządzeniu",
  "settings.general.row.colorScheme.title": "Schemat kolorów",
  "settings.general.row.colorScheme.description":
    "Wybierz, czy O M A I + ma używać motywu systemowego, jasnego czy ciemnego",
  "settings.general.row.theme.title": "Motyw",
  "settings.general.row.theme.description": "Dostosuj motyw O M A I +.",
  ...
  "settings.updates.row.startup.description": "Automatycznie sprawdzaj aktualizacje podczas uruchamiania O M A I +",
  ...
  "settings.updates.toast.latest.description": "Korzystasz z najnowszej wersji O M A I +.",
  ...
  "session.question.answeredProgress": "{{answered}} z {{total}} odpowiedziano",
  "session.question.custom.placeholder": "Napisz własną odpowiedź...",
  ...
  "preview.starting": "Uruchamianie podglądu...",
  "preview.loading": "Ładowanie podglądu...",
  "preview.title": "Podgląd",

  "preview.error.loadFailed": "Nie udało się załadować podglądu.",
  "preview.action.reload": "Odśwież",
  "preview.action.reloadPreview": "Odśwież podgląd",
  "preview.action.openInBrowser": "Otwórz w przeglądarce",
  "dialog.createProject.title": "Utwórz projekt",
  "dialog.createProject.creating": "Tworzenie projektu...",
  "dialog.createProject.nameLabel": "Nazwa projektu",
  "dialog.createProject.namePlaceholder": "mój-projekt",
  "dialog.createProject.nameHint": "Tylko litery, cyfry, myślniki i podkreślenia. Bez spacji.",
  "dialog.createProject.nameRequired": "Wprowadź nazwę projektu",
  "dialog.createProject.duplicate": 'Projekt już istnieje w "{{path}}"',
  "dialog.createProject.zipLabel": "Utwórz z folderu Zip (opcjonalnie)",
  "dialog.createProject.zipDropzone": "Upuść plik zip tutaj lub kliknij, aby przeglądać",
  "dialog.createProject.zipMaxSize": "Maksymalny rozmiar zip: 200MB",
  "dialog.createProject.zipTooLarge": "Plik zip musi być mniejszy niż {{size}}MB",
  "dialog.createProject.step.directory": "Tworzenie katalogu projektu...",
  "dialog.createProject.step.git": "Inicjalizacja repozytorium git...",
  "dialog.createProject.step.zip": "Rozpakowywanie pliku zip...",
  "dialog.createProject.step.opening": "Otwieranie projektu...",
  "dialog.createProject.step.cleanup": "Czyszczenie...",
  "dialog.createProject.error.zipExtract": "Nie udało się rozpakować pliku zip",
  "dialog.createProject.error.createFailed": "Nie udało się utworzyć projektu",
  "session.panel.collapseToReview": "Zwiń do przeglądu",
  "session.panel.restoreSplitView": "Przywróć widok podzielony",
  "allProjects.view.grid": "Widok siatki",
  "allProjects.view.list": "Widok listy",
  "auth.login.stealthMode": "TRYB UKRYCIA",
  "session.prompt.disclaimer": "O M A I + to AI i może popełniać błędy. Proszę sprawdzać odpowiedzi.",
}
