export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "โมเดลฟรีที่จัดหาให้โดย O M A I +",
  ...
  "provider.connect.apiKey.description":
    "ป้อนคีย์ API ของ {{provider}} เพื่อเชื่อมต่อบัญชีและใช้โมเดล {{provider}} ใน O M A I +",
  ...
  "provider.connect.opencodeZen.line1":
    "O M A I + Zen ให้คุณเข้าถึงชุดโมเดลที่เชื่อถือได้และปรับแต่งแล้วสำหรับเอเจนต์การเขียนโค้ด",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " เพื่อรวบรวมรหัสการอนุญาตของคุณเพื่อเชื่อมต่อบัญชีและใช้โมเดล {{provider}} ใน O M A I +",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " และป้อนรหัสด้านล่างเพื่อเชื่อมต่อบัญชีและใช้โมเดล {{provider}} ใน O M A I +",
  ...
  "session.question.pendingAnswer": "กรุณาตอบคำถาม",
  ...
  "dialog.mcp.empty": "ไม่มีการกำหนดค่า MCP",
  "dialog.mcp.hint": "สถานะ MCP server จะแสดงในตัวบ่งชี้สถานะ session เมื่อเปิดโปรเจกต์",
  ...
  "dialog.server.description": "สลับเซิร์ฟเวอร์ O M A I + ที่แอปนี้เชื่อมต่อด้วย",
  ...
  "wsl.onboarding.checkingOpencode": "กำลังตรวจสอบ O M A I +...",
  "wsl.onboarding.checkingOpencodeIn": "กำลังตรวจสอบ O M A I + ใน {{distro}}...",
  "wsl.onboarding.updatingOpencode": "กำลังอัปเดต O M A I +...",
  "wsl.onboarding.updatingOpencodeIn": "กำลังอัปเดต O M A I + ใน {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "อัปเดต O M A I + ใน {{distro}}.",
  "wsl.onboarding.updateOpencode": "อัปเดต O M A I +",
  "wsl.onboarding.opencodeReadyIn": "O M A I + พร้อมใช้งานใน {{distro}} แล้ว.",
  "wsl.onboarding.opencodeReady": "O M A I + พร้อมใช้งานแล้ว.",
  "wsl.onboarding.installOpencodeIn": "ติดตั้ง O M A I + ใน {{distro}}.",
  "wsl.onboarding.installOpencode": "ติดตั้ง O M A I +",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "ยังไม่ได้ติดตั้ง O M A I +",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "ต้องมี WSL (Windows Subsystem for Linux) ก่อนที่ O M A I + จะเพิ่มเซิร์ฟเวอร์ WSL ได้",
  "wsl.onboarding.wslUnavailable.title": "WSL ไม่พร้อมใช้งาน",
  "wsl.onboarding.wslUnavailable.description": "O M A I + ไม่สามารถตรวจสอบ WSL บนเครื่องนี้ได้.",
  "wsl.onboarding.installWsl": "ติดตั้ง WSL",
  "wsl.onboarding.windowsRestartRequired":
    "รีสตาร์ท Windows เพื่อให้การติดตั้ง WSL เสร็จสมบูรณ์ แล้วเปิด O M A I + อีกครั้ง.",
  ...
  "toast.update.description": "เวอร์ชันใหม่ของ O M A I + ({{version}}) พร้อมใช้งานสำหรับติดตั้ง",
  ...
  "error.page.report.prefix": "โปรดรายงานข้อผิดพลาดนี้ให้ทีม O M A I +",
  ...
  "error.chain.mcpFailed": 'เซิร์ฟเวอร์ MCP "{{name}}" ล้มเหลว โปรดทราบว่า O M A I + ยังไม่รองรับการตรวจสอบสิทธิ์ MCP',
  ...
  "sidebar.gettingStarted.line1": "O M A I + รวมถึงโมเดลฟรีเพื่อให้คุณเริ่มต้นได้ทันที",
  ...
  "settings.desktop.wsl.description": "เรียกใช้เซิร์ฟเวอร์ O M A I + ภายใน WSL บน Windows",
  ...
  "settings.general.row.language.description": "เปลี่ยนภาษาที่แสดงสำหรับ O M A I +",
  ...
  "settings.general.row.appearance.description": "ปรับแต่งวิธีการที่ O M A I + มีลักษณะบนอุปกรณ์ของคุณ",
  "settings.general.row.colorScheme.title": "โทนสี",
  "settings.general.row.colorScheme.description": "เลือกว่าจะให้ O M A I + ใช้ธีมตามระบบ สว่าง หรือมืด",
  "settings.general.row.theme.title": "ธีม",
  "settings.general.row.theme.description": "ปรับแต่งวิธีการที่ O M A I + มีธีม",
  ...
  "settings.updates.row.startup.description": "ตรวจสอบการอัปเดตโดยอัตโนมัติเมื่อ O M A I + เปิดใช้งาน",
  ...
  "settings.updates.toast.latest.description": "คุณกำลังใช้งาน O M A I + เวอร์ชันล่าสุด",
  ...
  "session.question.answeredProgress": "{{answered}} จาก {{total}} ตอบแล้ว",
  "session.question.custom.placeholder": "เขียนคำตอบของคุณเอง...",
  ...
  "preview.starting": "กำลังเริ่มต้นตัวอย่าง...",
  "preview.loading": "กำลังโหลดตัวอย่าง...",
  "preview.title": "ตัวอย่าง",

  "preview.error.loadFailed": "ไม่สามารถโหลดตัวอย่างได้",
  "preview.action.reload": "รีโหลด",
  "preview.action.reloadPreview": "รีโหลดตัวอย่าง",
  "preview.action.openInBrowser": "เปิดในเบราว์เซอร์",
  "dialog.createProject.title": "สร้างโปรเจกต์",
  "dialog.createProject.creating": "กำลังสร้างโปรเจกต์...",
  "dialog.createProject.nameLabel": "ชื่อโปรเจกต์",
  "dialog.createProject.namePlaceholder": "my-project",
  "dialog.createProject.nameHint": "ตัวอักษร ตัวเลข ขีดกลาง และขีดล่างเท่านั้น ไม่มีช่องว่าง",
  "dialog.createProject.nameRequired": "กรุณาใส่ชื่อโปรเจกต์",
  "dialog.createProject.duplicate": 'มีโปรเจกต์อยู่แล้วที่ "{{path}}"',
  "dialog.createProject.zipLabel": "สร้างจากโฟลเดอร์ Zip (ไม่บังคับ)",
  "dialog.createProject.zipDropzone": "วางไฟล์ zip ที่นี่หรือคลิกเพื่อเรียกดู",
  "dialog.createProject.zipMaxSize": "ขนาด zip สูงสุด: 200MB",
  "dialog.createProject.zipTooLarge": "ไฟล์ zip ต้องมีขนาดไม่เกิน {{size}}MB",
  "dialog.createProject.step.directory": "กำลังสร้างไดเรกทอรีโปรเจกต์...",
  "dialog.createProject.step.git": "กำลังเริ่มต้น git repository...",
  "dialog.createProject.step.zip": "กำลังแตกไฟล์ zip...",
  "dialog.createProject.step.opening": "กำลังเปิดโปรเจกต์...",
  "dialog.createProject.step.cleanup": "กำลังทำความสะอาด...",
  "dialog.createProject.error.zipExtract": "ไม่สามารถแตกไฟล์ zip ได้",
  "dialog.createProject.error.createFailed": "ไม่สามารถสร้างโปรเจกต์ได้",
  "session.panel.collapseToReview": "ย่อเพื่อตรวจสอบ",
  "session.panel.restoreSplitView": "กู้คืนมุมมองแบบแบ่ง",
  "allProjects.view.grid": "มุมมองตาราง",
  "allProjects.view.list": "มุมมองรายการ",
  "auth.login.stealthMode": "โหมดลับ",
  "session.prompt.disclaimer": "O M A I + คือ AI และอาจผิดพลาดได้ โปรดตรวจสอบคำตอบอีกครั้ง",
}
