export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "نماذج مجانية مقدمة من O M A I +",
  ...
  "provider.connect.apiKey.description":
    "أدخل مفتاح واجهة برمجة تطبيقات {{provider}} الخاص بك لتوصيل حسابك واستخدام نماذج {{provider}} في O M A I +.",
  ...
  "provider.connect.opencodeZen.line1":
    "يمنحك O M A I + Zen الوصول إلى مجموعة مختارة من النماذج الموثوقة والمحسنة لوكلاء البرمجة.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " للحصول على رمز التفويض الخاص بك لتوصيل حسابك واستخدام نماذج {{provider}} في O M A I +.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " وأدخل الرمز أدناه لتوصيل حسابك واستخدام نماذج {{provider}} في O M A I +.",
  ...
  "session.question.pendingAnswer": "الرجاء الإجابة على الأسئلة",
  ...
  "dialog.mcp.empty": "لم يتم تكوين أي MCP",
  "dialog.mcp.hint": "يتم عرض حالة خادم MCP في مؤشر حالة الجلسان عند فتح مشروع.",
  ...
  "dialog.server.description": "تبديل خادم O M A I + الذي يتصل به هذا التطبيق.",
  ...
  "wsl.onboarding.checkingOpencode": "جارٍ التحقق من O M A I +...",
  "wsl.onboarding.checkingOpencodeIn": "جارٍ التحقق من O M A I + في {{distro}}...",
  "wsl.onboarding.updatingOpencode": "جارٍ تحديث O M A I +...",
  "wsl.onboarding.updatingOpencodeIn": "جارٍ تحديث O M A I + في {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "حدّث O M A I + في {{distro}}.",
  "wsl.onboarding.updateOpencode": "تحديث O M A I +",
  "wsl.onboarding.opencodeReadyIn": "O M A I + جاهز في {{distro}}.",
  "wsl.onboarding.opencodeReady": "O M A I + جاهز.",
  "wsl.onboarding.installOpencodeIn": "ثبّت O M A I + في {{distro}}.",
  "wsl.onboarding.installOpencode": "تثبيت O M A I +",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "O M A I + غير مثبت",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "يلزم WSL (نظام Windows الفرعي لـ Linux) قبل أن يتمكن O M A I + من إضافة خادم WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL غير متاح",
  "wsl.onboarding.wslUnavailable.description": "تعذر على O M A I + التحقق من WSL على هذا الجهاز.",
  "wsl.onboarding.installWsl": "تثبيت WSL",
  "wsl.onboarding.windowsRestartRequired": "أعد تشغيل Windows لإكمال تثبيت WSL، ثم أعد فتح O M A I +.",
  ...
  "toast.update.description": "نسخة جديدة من O M A I + ({{version}}) متاحة الآن للتثبيت.",
  ...
  "error.page.report.prefix": "يرجى الإبلاغ عن هذا الخطأ لفريق O M A I +",
  ...
  "error.chain.mcpFailed": 'فشل خادم MCP "{{name}}". لاحظ أن O M A I + لا يدعم مصادقة MCP بعد.',
  ...
  "sidebar.gettingStarted.line1": "يتضمن O M A I + نماذج مجانية حتى تتمكن من البدء فورًا.",
  ...
  "settings.desktop.wsl.description": "تشغيل خادم O M A I + داخل WSL على Windows.",
  ...
  "settings.general.row.language.description": "تغيير لغة العرض لـ O M A I +",
  ...
  "settings.general.row.appearance.description": "تخصيص كيفية ظهور O M A I + على جهازك",
  "settings.general.row.colorScheme.title": "مخطط الألوان",
  "settings.general.row.colorScheme.description": "اختر ما إذا كان O M A I + يتبع سمة النظام أو الفاتح أو الداكن",
  "settings.general.row.theme.title": "السمة",
  "settings.general.row.theme.description": "تخصيص سمة O M A I +.",
  ...
  "settings.updates.row.startup.description": "التحقق تلقائيًا من التحديثات عند تشغيل O M A I +",
  ...
  "settings.updates.toast.latest.description": "أنت تستخدم أحدث إصدار من O M A I +.",
  ...
  "session.question.answeredProgress": "تمت الإجابة على {{answered}} من {{total}}",
  "session.question.custom.placeholder": "اكتب ردًا مخصصًا...",
  ...
  "preview.starting": "جاري بدء المعاينة...",
  "preview.loading": "جاري تحميل المعاينة...",
  "preview.title": "المعاينة",

  "preview.error.loadFailed": "فشل تحميل المعاينة.",
  "preview.action.reload": "إعادة تحميل",
  "preview.action.reloadPreview": "إعادة تحميل المعاينة",
  "preview.action.openInBrowser": "فتح في المتصفح",
  "dialog.createProject.title": "إنشاء مشروع",
  "dialog.createProject.creating": "جاري إنشاء المشروع...",
  "dialog.createProject.nameLabel": "اسم المشروع",
  "dialog.createProject.namePlaceholder": "مشروعي",
  "dialog.createProject.nameHint": "أحرف وأرقام وشرطات وشرطات سفلية فقط. بدون مسافات.",
  "dialog.createProject.nameRequired": "يرجى إدخال اسم المشروع",
  "dialog.createProject.duplicate": 'يوجد مشروع بالفعل في "{{path}}"',
  "dialog.createProject.zipLabel": "إنشاء من مجلد مضغوط (اختياري)",
  "dialog.createProject.zipDropzone": "اسحب ملفًا مضغوطًا هنا أو انقر للتصفح",
  "dialog.createProject.zipMaxSize": "الحد الأقصى للملف المضغوط: 200 ميجابايت",
  "dialog.createProject.zipTooLarge": "يجب أن يكون حجم الملف المضغوط أقل من {{size}} ميجابايت",
  "dialog.createProject.step.directory": "جاري إنشاء دليل المشروع...",
  "dialog.createProject.step.git": "جاري تهيئة مستودع git...",
  "dialog.createProject.step.zip": "جاري استخراج الملف المضغوط...",
  "dialog.createProject.step.opening": "جاري فتح المشروع...",
  "dialog.createProject.step.cleanup": "جاري التنظيف...",
  "dialog.createProject.error.zipExtract": "فشل استخراج الملف المضغوط",
  "dialog.createProject.error.createFailed": "فشل إنشاء المشروع",
  "session.panel.collapseToReview": "طي للمراجعة",
  "session.panel.restoreSplitView": "استعادة العرض المقسّم",
  "allProjects.view.grid": "عرض شبكي",
  "allProjects.view.list": "عرض قائمة",
  "auth.login.stealthMode": "وضع التخفي",
  "session.prompt.disclaimer": "O M A I + هو ذكاء اصطناعي وقد يرتكب أخطاء. يرجى التحقق من الردود.",
}
