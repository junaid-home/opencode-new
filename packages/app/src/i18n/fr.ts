export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Modèles gratuits fournis par O M A I +",
  ...
  "provider.connect.apiKey.description":
    "Entrez votre clé API {{provider}} pour connecter votre compte et utiliser les modèles {{provider}} dans O M A I +.",
  ...
  "provider.connect.opencodeZen.line1":
    "O M A I + Zen vous donne accès à un ensemble sélectionné de modèles fiables et optimisés pour les agents de codage.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " pour récupérer votre code d'autorisation afin de connecter votre compte et utiliser les modèles {{provider}} dans O M A I +.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " et entrez le code ci-dessous pour connecter votre compte et utiliser les modèles {{provider}} dans O M A I +.",
  ...
  "session.question.pendingAnswer": "Veuillez répondre aux questions",
  ...
  "dialog.mcp.hint": "L'état du serveur MCP est affiché dans l'indicateur d'état de la session lorsqu'un projet est ouvert.",
  ...
  "dialog.server.description": "Changez le serveur O M A I + auquel cette application se connecte.",
  ...
  "wsl.onboarding.checkingOpencode": "Vérification d'O M A I +...",
  "wsl.onboarding.checkingOpencodeIn": "Vérification d'O M A I + dans {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Mise à jour d'O M A I +...",
  "wsl.onboarding.updatingOpencodeIn": "Mise à jour d'O M A I + dans {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Mettez à jour O M A I + dans {{distro}}.",
  "wsl.onboarding.updateOpencode": "Mettre à jour O M A I +",
  "wsl.onboarding.opencodeReadyIn": "O M A I + est prêt dans {{distro}}.",
  "wsl.onboarding.opencodeReady": "O M A I + est prêt.",
  "wsl.onboarding.installOpencodeIn": "Installez O M A I + dans {{distro}}.",
  "wsl.onboarding.installOpencode": "Installer O M A I +",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "O M A I + non installé",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) est requis avant qu'O M A I + puisse ajouter un serveur WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL indisponible",
  "wsl.onboarding.wslUnavailable.description": "O M A I + n'a pas pu vérifier WSL sur cet appareil.",
  "wsl.onboarding.installWsl": "Installer WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Redémarrez Windows pour terminer l'installation de WSL, puis rouvrez O M A I +.",
  ...
  "toast.update.description":
    "Une nouvelle version d'O M A I + ({{version}}) est maintenant disponible pour installation.",
  ...
  "error.page.report.prefix": "Veuillez signaler cette erreur à l'équipe O M A I +",
  ...
  "error.chain.mcpFailed":
    "Le serveur MCP \"{{name}}\" a échoué. Notez qu'O M A I + ne supporte pas encore l'authentification MCP.",
  ...
  "sidebar.gettingStarted.line1":
    "O M A I + inclut des modèles gratuits pour que vous puissiez commencer immédiatement.",
  ...
  "settings.desktop.wsl.description": "Exécuter le serveur O M A I + dans WSL sur Windows.",
  ...
  "settings.general.row.language.description": "Changer la langue d'affichage pour O M A I +",
  ...
  "settings.general.row.appearance.description": "Personnaliser l'apparence d'O M A I + sur votre appareil",
  "settings.general.row.colorScheme.title": "Schéma de couleurs",
  "settings.general.row.colorScheme.description": "Choisissez si O M A I + suit le thème système, clair ou sombre",
  "settings.general.row.theme.title": "Thème",
  "settings.general.row.theme.description": "Personnaliser le thème d'O M A I +.",
  ...
  "settings.updates.row.startup.description": "Vérifier automatiquement les mises à jour au lancement d'O M A I +",
  ...
  "settings.updates.toast.latest.description": "Vous utilisez la dernière version d'O M A I +.",
  ...
  "session.question.answeredProgress": "{{answered}} sur {{total}} répondues",
  "session.question.custom.placeholder": "Écrivez une réponse personnalisée...",
  ...
  "preview.starting": "Démarrage de l'aperçu...",
  "preview.loading": "Chargement de l'aperçu...",
  "preview.title": "Aperçu",

  "preview.error.loadFailed": "Échec du chargement de l'aperçu.",
  "preview.action.reload": "Recharger",
  "preview.action.reloadPreview": "Recharger l'aperçu",
  "preview.action.openInBrowser": "Ouvrir dans le navigateur",
  "dialog.createProject.title": "Créer un projet",
  "dialog.createProject.creating": "Création du projet...",
  "dialog.createProject.nameLabel": "Nom du projet",
  "dialog.createProject.namePlaceholder": "mon-projet",
  "dialog.createProject.nameHint": "Lettres, chiffres, tirets et underscores uniquement. Pas d'espaces.",
  "dialog.createProject.nameRequired": "Veuillez entrer un nom de projet",
  "dialog.createProject.duplicate": 'Un projet existe déjà à "{{path}}"',
  "dialog.createProject.zipLabel": "Créer à partir d'un dossier Zip (optionnel)",
  "dialog.createProject.zipDropzone": "Déposez le fichier zip ici ou cliquez pour parcourir",
  "dialog.createProject.zipMaxSize": "Taille maximale du zip : 200 Mo",
  "dialog.createProject.zipTooLarge": "Le fichier zip doit être inférieur à {{size}} Mo",
  "dialog.createProject.step.directory": "Création du répertoire du projet...",
  "dialog.createProject.step.git": "Initialisation du dépôt git...",
  "dialog.createProject.step.zip": "Extraction du fichier zip...",
  "dialog.createProject.step.opening": "Ouverture du projet...",
  "dialog.createProject.step.cleanup": "Nettoyage...",
  "dialog.createProject.error.zipExtract": "Échec de l'extraction du fichier zip",
  "dialog.createProject.error.createFailed": "Échec de la création du projet",
  "session.panel.collapseToReview": "Réduire pour examiner",
  "session.panel.restoreSplitView": "Restaurer la vue partagée",
  "allProjects.view.grid": "Vue en grille",
  "allProjects.view.list": "Vue en liste",
  "auth.login.stealthMode": "MODE FURTIF",
  "session.prompt.disclaimer": "O M A I + est une IA et peut faire des erreurs. Veuillez vérifier les réponses.",
}
