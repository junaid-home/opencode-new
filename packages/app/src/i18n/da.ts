export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller leveret af O M A I +",
  ...
  "provider.connect.apiKey.description":
    "Indtast din {{provider}} API-nøgle for at forbinde din konto og bruge {{provider}} modeller i O M A I +.",
  ...
  "provider.connect.opencodeZen.line1":
    "O M A I + Zen giver dig adgang til et udvalg af pålidelige optimerede modeller til kodningsagenter.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " for at hente din godkendelseskode for at forbinde din konto og bruge {{provider}} modeller i O M A I +.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og indtast koden nedenfor for at forbinde din konto og bruge {{provider}} modeller i O M A I +.",
  ...
  "session.question.pendingAnswer": "Besvar venligst spørgsmålene",
  ...
  "dialog.mcp.hint": "MCP-serverens status vises i sessionsstatusindikatoren, når et projekt er åbent.",
  ...
  "dialog.server.description": "Skift hvilken O M A I +-server denne app forbinder til.",
  ...
  "wsl.onboarding.checkingOpencode": "Tjekker O M A I +...",
  "wsl.onboarding.checkingOpencodeIn": "Tjekker O M A I + i {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Opdaterer O M A I +...",
  "wsl.onboarding.updatingOpencodeIn": "Opdaterer O M A I + i {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Opdater O M A I + i {{distro}}.",
  "wsl.onboarding.updateOpencode": "Opdater O M A I +",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "O M A I + er ikke installeret",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) er påkrævet, før O M A I + kan tilføje en WSL-server",
  "wsl.onboarding.wslUnavailable.title": "WSL er ikke tilgængelig",
  "wsl.onboarding.wslUnavailable.description": "O M A I + kunne ikke bekræfte WSL på denne maskine.",
  "wsl.onboarding.installWsl": "Installer WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Genstart Windows for at fuldføre installationen af WSL, og åbn derefter O M A I + igen.",
  ...
  "toast.update.description": "En ny version af O M A I + ({{version}}) er nu tilgængelig til installation.",
  ...
  "error.page.report.prefix": "Rapporter venligst denne fejl til O M A I +-teamet",
  ...
  "error.chain.mcpFailed": 'MCP-server "{{name}}" fejlede. Bemærk, O M A I + understøtter ikke MCP-godkendelse endnu.',
  ...
  "sidebar.gettingStarted.line1": "O M A I + inkluderer gratis modeller så du kan starte med det samme.",
  ...
  "settings.desktop.wsl.description": "Kør O M A I +-serveren inde i WSL på Windows.",
  ...
  "settings.general.row.language.description": "Ændr visningssproget for O M A I +",
  ...
  "settings.general.row.appearance.description": "Tilpas hvordan O M A I + ser ud på din enhed",
  "settings.general.row.colorScheme.title": "Farveskema",
  "settings.general.row.colorScheme.description": "Vælg om O M A I + følger systemets, lyst eller mørkt tema",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpas hvordan O M A I + er temabestemt.",
  ...
  "settings.updates.row.startup.description": "Tjek automatisk for opdateringer, når O M A I + starter",
  ...
  "settings.updates.toast.latest.description": "Du kører den nyeste version af O M A I +.",
  ...
  "session.question.answeredProgress": "{{answered}} af {{total}} besvaret",
  "session.question.custom.placeholder": "Skriv et brugerdefineret svar...",
  ...
  "preview.error.loadFailed": "Kunne ikke indlæse forhåndsvisning.",
  "preview.action.reload": "Genindlæs",
  "preview.action.reloadPreview": "Genindlæs forhåndsvisning",
  "preview.action.openInBrowser": "Åbn i browser",
  "dialog.createProject.title": "Opret projekt",
  "dialog.createProject.creating": "Opretter projekt...",
  "dialog.createProject.nameLabel": "Projektnavn",
  "dialog.createProject.namePlaceholder": "mit-projekt",
  "dialog.createProject.nameHint": "Kun bogstaver, tal, bindestreger og understreger. Ingen mellemrum.",
  "dialog.createProject.nameRequired": "Indtast venligst et projektnavn",
  "dialog.createProject.duplicate": 'Et projekt findes allerede på "{{path}}"',
  "dialog.createProject.zipLabel": "Opret fra zip-mappe (valgfrit)",
  "dialog.createProject.zipDropzone": "Slip zip-fil her eller klik for at gennemse",
  "dialog.createProject.zipMaxSize": "Maksimal zip-størrelse: 200MB",
  "dialog.createProject.zipTooLarge": "Zip-filen skal være under {{size}}MB",
  "dialog.createProject.step.directory": "Opretter projektmappe...",
  "dialog.createProject.step.git": "Initialiserer git-repository...",
  "dialog.createProject.step.zip": "Udpakker zip-fil...",
  "dialog.createProject.step.opening": "Åbner projekt...",
  "dialog.createProject.step.cleanup": "Rydder op...",
  "dialog.createProject.error.zipExtract": "Kunne ikke udpakke zip-fil",
  "dialog.createProject.error.createFailed": "Kunne ikke oprette projekt",
  "session.panel.collapseToReview": "Fold sammen til gennemgang",
  "session.panel.restoreSplitView": "Gendan delt visning",
  "allProjects.view.grid": "Gittervisning",
  "allProjects.view.list": "Listevisning",
  "auth.login.stealthMode": "SKJULT TILSTAND",
  "session.prompt.disclaimer": "O M A I + er AI og kan lave fejl. Tjek venligst svarene.",
}
