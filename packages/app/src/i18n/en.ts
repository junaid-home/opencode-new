export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Free models provided by O M A I +",
  ...
  "provider.connect.apiKey.description":
    "Enter your {{provider}} API key to connect your account and use {{provider}} models in O M A I +.",
  "provider.connect.apiKey.label": "{{provider}} API key",
  "provider.connect.apiKey.placeholder": "API key",
  "provider.connect.apiKey.required": "API key is required",
  "provider.connect.opencodeZen.line1":
    "O M A I + Zen gives you access to a curated set of reliable optimized models for coding agents.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " to collect your authorization code to connect your account and use {{provider}} models in O M A I +.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " and enter the code below to connect your account and use {{provider}} models in O M A I +.",
  ...
  "session.question.pendingAnswer": "Please answer the questions",
  "session.prompt.disclaimer": "O M A I + is AI and can make mistakes. Please double-check responses.",
  ...
  "dialog.mcp.hint": "MCP server status is shown in the session status indicator when a project is open.",
  ...
  "dialog.server.description": "Switch which O M A I + server this app connects to.",
  ...
  "wsl.onboarding.step.opencode": "O M A I +",
  ...
  "wsl.onboarding.checkingOpencode": "Checking O M A I +...",
  "wsl.onboarding.checkingOpencodeIn": "Checking O M A I + in {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Updating O M A I +...",
  "wsl.onboarding.updatingOpencodeIn": "Updating O M A I + in {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Update O M A I + in {{distro}}.",
  "wsl.onboarding.updateOpencode": "Update O M A I +",
  "wsl.onboarding.opencodeReadyIn": "O M A I + is ready in {{distro}}.",
  "wsl.onboarding.opencodeReady": "O M A I + is ready.",
  "wsl.onboarding.installOpencodeIn": "Install O M A I + in {{distro}}.",
  "wsl.onboarding.installOpencode": "Install O M A I +",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "O M A I + not installed",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) is required before O M A I + can add a WSL server",
  "wsl.onboarding.wslUnavailable.title": "WSL unavailable",
  "wsl.onboarding.wslUnavailable.description": "O M A I + could not verify WSL on this machine.",
  "wsl.onboarding.installWsl": "Install WSL",
  "wsl.onboarding.windowsRestartRequired": "Restart Windows to finish installing WSL, then reopen O M A I +.",
  ...
  "toast.update.description": "A new version of O M A I + ({{version}}) is now available to install.",
  ...
  "error.page.report.prefix": "Please report this error to the O M A I + team",
  ...
  "error.chain.mcpFailed": 'MCP server "{{name}}" failed. Note, O M A I + does not support MCP authentication yet.',
  ...
  "projects.empty.description": "Open a local project to get started",
  "projects.delete.title": "Delete Project",
  "projects.delete.confirm": "Are you sure you want to remove \"{{name}}\" from your recent projects?",
  "projects.showAll": "Show all ({{count}})",
  "projects.new": "New Project",
  "projects.open": "Open Project",

  "allProjects.searchPlaceholder": "Search projects...",
  "allProjects.noResults": "No projects found",
  "allProjects.tryDifferentSearch": "Try a different search term",
  "allProjects.pagination.previous": "Previous",
  "allProjects.pagination.next": "Next",
  "allProjects.showingResults": "Showing {{count}} of {{total}} projects",
  ...
  "session.question.answeredProgress": "{{answered}} of {{total}} answered",
  "session.question.custom.placeholder": "Write a custom response...",
  ...
  "sidebar.gettingStarted.line1": "O M A I + includes free models so you can start immediately.",
  ...
  "app.name.desktop": "O M A I + Desktop",
  ...
  "settings.desktop.wsl.description": "Run the O M A I + server inside WSL on Windows.",
  ...
  "settings.general.row.language.description": "Change the display language for O M A I +",
  "settings.general.row.shell.title": "Terminal shell",
  "settings.general.row.shell.description": "Shell used by the terminal and agent tools",
  "settings.general.row.shell.autoDefault": "Auto (Default)",
  "settings.general.row.shell.terminalOnly": "terminal only",
  "settings.general.row.appearance.title": "Appearance",
  "settings.general.row.appearance.description": "Customise how O M A I + looks on your device",
  "settings.general.row.colorScheme.title": "Color scheme",
  "settings.general.row.colorScheme.description": "Choose whether O M A I + follows the system, light, or dark theme",
  "settings.general.row.theme.title": "Theme",
  "settings.general.row.theme.description": "Customise how O M A I + is themed.",
  ...
  "settings.general.row.showSessionProgressBar.title": "Session progress bar",
  "settings.general.row.showSessionProgressBar.description": "Show an animated progress bar at the top of the session when the model is working",
  ...
  "settings.updates.row.startup.description": "Automatically check for updates when O M A I + launches",
  ...
  "settings.updates.toast.latest.description": "You're running the latest version of O M A I +.",
  ...
  "preview.action.reload": "Reload",
  "preview.action.reloadPreview": "Reload preview",
  "preview.action.openInBrowser": "Open in browser",

  // Create Project Dialog
  "dialog.createProject.title": "Create Project",
  "dialog.createProject.creating": "Creating project...",
  "dialog.createProject.nameLabel": "Project Name",
  "dialog.createProject.namePlaceholder": "my-project",
  "dialog.createProject.nameHint": "Only letters, numbers, hyphens, and underscores. No spaces.",
  "dialog.createProject.nameRequired": "Please enter a project name",
  "dialog.createProject.duplicate": 'A project already exists at "{{path}}"',
  "dialog.createProject.zipLabel": "Create from Zip folder (optional)",
  "dialog.createProject.zipDropzone": "Drop zip file here or click to browse",
  "dialog.createProject.zipMaxSize": "Max zip: 200MB",
  "dialog.createProject.zipTooLarge": "Zip file must be under {{size}}MB",
  "dialog.createProject.step.directory": "Creating project directory...",
  "dialog.createProject.step.git": "Initializing git repository...",
  "dialog.createProject.step.zip": "Extracting zip file...",
  "dialog.createProject.step.uploading": "Uploading zip file...",
  "dialog.createProject.step.opening": "Opening project...",
  "dialog.createProject.step.cleanup": "Cleaning up...",
  "dialog.createProject.error.zipExtract": "Failed to extract zip file",
  "dialog.createProject.error.createFailed": "Failed to create project",

  // Session Panel Toggle
  "session.panel.collapseToReview": "Collapse to review",
  "session.panel.restoreSplitView": "Restore split view",

  // All Projects
  "allProjects.view.grid": "Grid view",
  "allProjects.view.list": "List view",

  // Auth
  "auth.login.title": "Welcome back",
  "auth.login.subtitle": "Sign in to your O M A I + account",
  "auth.login.username.label": "Username or Email",
  "auth.login.username.placeholder": "username or email@example.com",
  "auth.login.password.label": "Password",
  "auth.login.submit": "Sign In",
  "auth.login.submitting": "Signing in...",
  "auth.login.noAccount": "Don't have an account?",
  "auth.login.signup": "Sign up",
  "auth.login.error.required": "Please enter your username/email and password",
  "auth.login.stealthMode": "STEALTH MODE",

  "auth.signup.title": "Create account",
  "auth.signup.subtitle": "Get started with O M A I +",
  "auth.signup.username.label": "Username",
  "auth.signup.username.placeholder": "myusername",
  ...
  "auth.signup.error.usernameLength": "Username must be 3-30 characters",
