...
export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "O M A I + tarafından sunulan ücretsiz modeller",
  ...
  "provider.connect.apiKey.description":
    "{{provider}} hesabınızı bağlamak ve O M A I +'da {{provider}} modellerini kullanmak için API anahtarınızı girin.",
  ...
  "provider.connect.opencodeZen.line1":
    "O M A I + Zen, kodlama ajanları için seçilmiş güvenilir optimize edilmiş modellere erişim sağlar.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " gidin; ardından hesabınızı bağlayarak O M A I +'da {{provider}} modellerini kullanın.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " tıklayarak aşağıdaki kodu girin ve hesabınızı bağlayarak O M A I +'da {{provider}} modellerini kullanın.",
  ...
  "session.question.pendingAnswer": "Lütfen soruları yanıtlayın",
  ...
  "dialog.mcp.empty": "MCP yapılandırılmamış",
  "dialog.mcp.hint": "Proje açıldığında MCP sunucu durumu oturum durum göstergesinde görüntülenir.",
  ...
  "dialog.server.description": "Bu uygulamanın hangi O M A I + sunucusuna bağlanacağını değiştirin.",
  ...
  "wsl.onboarding.checkingOpencode": "O M A I + kontrol ediliyor...",
  "wsl.onboarding.checkingOpencodeIn": "{{distro}} içinde O M A I + kontrol ediliyor...",
  "wsl.onboarding.updatingOpencode": "O M A I + güncelleniyor...",
  "wsl.onboarding.updatingOpencodeIn": "{{distro}} içinde O M A I + güncelleniyor...",
  "wsl.onboarding.updateOpencodeIn": "{{distro}} içindeki O M A I +'u güncelleyin.",
  "wsl.onboarding.updateOpencode": "O M A I +'u güncelle",
  "wsl.onboarding.opencodeReadyIn": "{{distro}} içinde O M A I + hazır.",
  "wsl.onboarding.opencodeReady": "O M A I + hazır.",
  "wsl.onboarding.installOpencodeIn": "O M A I +'u {{distro}} içine kurun.",
  "wsl.onboarding.installOpencode": "O M A I +'u kur",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "O M A I + kurulu değil",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "O M A I +'un WSL sunucusu ekleyebilmesi için önce WSL (Linux için Windows Alt Sistemi) kurulmalıdır",
  "wsl.onboarding.wslUnavailable.title": "WSL kullanılamıyor",
  "wsl.onboarding.wslUnavailable.description": "O M A I + bu makinede WSL'yi doğrulayamadı.",
  "wsl.onboarding.installWsl": "WSL'yi kur",
  "wsl.onboarding.windowsRestartRequired":
    "WSL kurulumunu tamamlamak için Windows'u yeniden başlatın, ardından O M A I +'u tekrar açın.",
  ...
  "toast.update.description": "O M A I +'un yeni bir sürümü ({{version}}) yüklemeye hazır.",
  ...
  "error.page.report.prefix": "Lütfen bu hatayı O M A I + ekibine bildirin",
  ...
  "error.chain.mcpFailed":
    'MCP sunucusu "{{name}}" başarısız oldu. Not: O M A I + henüz MCP kimlik doğrulamasını desteklemiyor.',
  ...
  "sidebar.gettingStarted.line1": "O M A I + ücretsiz modeller içerir, böylece hemen başlayabilirsiniz.",
  ...
  "app.name.desktop": "O M A I + Masaüstü",
  ...
  "settings.desktop.wsl.description": "O M A I + sunucusunu Windows'ta WSL içinde çalıştırın.",
  ...
  "settings.general.row.language.description": "O M A I +'un görünüm dilini değiştirin",
  ...
  "settings.general.row.appearance.description": "O M A I +'un cihazınızdaki görünümünü özelleştirin",
  "settings.general.row.colorScheme.title": "Renk şeması",
  "settings.general.row.colorScheme.description":
    "O M A I +'un sistem, açık veya koyu temayı takip etip etmeyeceğini seçin",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "O M A I +'un temasını özelleştirin.",
  ...
  "settings.updates.row.startup.description": "O M A I + başladığında otomatik güncelleme kontrolü yap",
  ...
  "settings.updates.toast.latest.description": "O M A I +'un en son sürümünü kullanıyorsunuz.",
  ...
  "session.question.answeredProgress": "{{total}} sorudan {{answered}} yanıtlandı",
  "session.question.custom.placeholder": "Özel bir cevap yazın...",
  ...
  "preview.starting": "Önizleme başlatılıyor...",
  "preview.loading": "Önizleme yükleniyor...",
  "preview.title": "Önizleme",

  "preview.error.loadFailed": "Önizleme yüklenemedi.",
  "preview.action.reload": "Yeniden yükle",
  "preview.action.reloadPreview": "Önizlemeyi yeniden yükle",
  "preview.action.openInBrowser": "Tarayıcıda aç",
  "dialog.createProject.title": "Proje Oluştur",
  "dialog.createProject.creating": "Proje oluşturuluyor...",
  "dialog.createProject.nameLabel": "Proje Adı",
  "dialog.createProject.namePlaceholder": "benim-projem",
  "dialog.createProject.nameHint": "Sadece harfler, sayılar, tireler ve alt çizgiler. Boşluk yok.",
  "dialog.createProject.nameRequired": "Lütfen bir proje adı girin",
  "dialog.createProject.duplicate": '"{{path}}" konumunda zaten bir proje var',
  "dialog.createProject.zipLabel": "Zip klasöründen oluştur (isteğe bağlı)",
  "dialog.createProject.zipDropzone": "Zip dosyasını buraya bırakın veya tıklayarak göz atın",
  "dialog.createProject.zipMaxSize": "Maksimum zip boyutu: 200MB",
  "dialog.createProject.zipTooLarge": "Zip dosyası {{size}}MB'dan küçük olmalıdır",
  "dialog.createProject.step.directory": "Proje dizini oluşturuluyor...",
  "dialog.createProject.step.git": "Git deposu başlatılıyor...",
  "dialog.createProject.step.zip": "Zip dosyası çıkartılıyor...",
  "dialog.createProject.step.opening": "Proje açılıyor...",
  "dialog.createProject.step.cleanup": "Temizleniyor...",
  "dialog.createProject.error.zipExtract": "Zip dosyası çıkartılamadı",
  "dialog.createProject.error.createFailed": "Proje oluşturulamadı",
  "session.panel.collapseToReview": "İncelemek için daralt",
  "session.panel.restoreSplitView": "Bölünmüş görünümü geri yükle",
  "allProjects.view.grid": "Izgara görünümü",
  "allProjects.view.list": "Liste görünümü",
  "auth.login.stealthMode": "GİZLİ MOD",
  "session.prompt.disclaimer": "O M A I + bir yapay zekadır ve hata yapabilir. Lütfen yanıtları kontrol edin.",
