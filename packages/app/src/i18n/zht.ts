...
export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "O M A I + 提供的免費模型",
  ...
  "provider.connect.apiKey.description":
    "輸入你的 {{provider}} API 金鑰以連線帳戶，並在 O M A I + 中使用 {{provider}} 模型。",
  ...
  "provider.connect.opencodeZen.line1": "O M A I + Zen 為你提供一組精選的可靠最佳化模型，用於程式碼代理程式。",
  ...
  "provider.connect.oauth.code.visit.suffix": " 取得授權碼，以連線你的帳戶並在 O M A I + 中使用 {{provider}} 模型。",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " 並輸入以下程式碼，以連線你的帳戶並在 O M A I + 中使用 {{provider}} 模型。",
  ...
  "session.question.pendingAnswer": "請回答問題。",
  ...
  "dialog.mcp.hint": "當專案開啟時，MCP 伺服器狀態會顯示在工作階段狀態指示器中。",
  ...
  "dialog.server.description": "切換此應用程式連線的 O M A I + 伺服器。",
  ...
  "wsl.onboarding.checkingOpencode": "正在檢查 O M A I +...",
  "wsl.onboarding.checkingOpencodeIn": "正在檢查 {{distro}} 中的 O M A I +...",
  ...
  "wsl.onboarding.opencodeReadyIn": "{{distro}} 中的 O M A I + 已就緒。",
  "wsl.onboarding.opencodeReady": "O M A I + 已就緒。",
  "wsl.onboarding.installOpencodeIn": "在 {{distro}} 中安裝 O M A I +。",
  "wsl.onboarding.installOpencode": "安裝 O M A I +",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "未安裝 O M A I +",
  ...
  "wsl.onboarding.wslUnavailable.description": "O M A I + 無法確認此電腦上的 WSL。",
  "wsl.onboarding.installWsl": "安裝 WSL",
  "wsl.onboarding.windowsRestartRequired": "重新啟動 Windows 以完成 WSL 安裝，然後重新開啟 O M A I +。",
  ...
  "toast.update.description": "O M A I + 有新版本 ({{version}}) 可安裝。",
  ...
  "error.page.report.prefix": "請將此錯誤回報給 O M A I + 團隊",
  ...
  "error.chain.mcpFailed": 'MCP 伺服器 "{{name}}" 啟動失敗。注意: O M A I + 暫不支援 MCP 認證。',
  ...
  "sidebar.gettingStarted.line1": "O M A I + 提供免費模型，你可以立即開始使用。",
  ...
  "settings.desktop.wsl.description": "在 Windows 上的 WSL 中執行 O M A I + 伺服器。",
  ...
  "settings.general.row.language.description": "變更 O M A I + 的顯示語言",
  ...
  "settings.general.row.appearance.description": "自訂 O M A I + 在你的裝置上的外觀",
  "settings.general.row.colorScheme.title": "配色方案",
  "settings.general.row.colorScheme.description": "選擇 O M A I + 要跟隨系統、淺色或深色主題",
  "settings.general.row.theme.title": "主題",
  "settings.general.row.theme.description": "自訂 O M A I + 的主題。",
  ...
  "settings.updates.row.startup.description": "在 O M A I + 啟動時自動檢查更新",
  ...
  "session.question.custom.placeholder": "輸入自訂答案...",
  ...
  "preview.starting": "正在啟動預覽...",
  "preview.loading": "正在載入預覽...",
  "preview.title": "預覽",

  "preview.error.loadFailed": "載入預覽失敗。",
  "preview.action.reload": "重新載入",
  "preview.action.reloadPreview": "重新載入預覽",
  "preview.action.openInBrowser": "在瀏覽器中開啟",
  "dialog.createProject.title": "建立專案",
  "dialog.createProject.creating": "正在建立專案...",
  "dialog.createProject.nameLabel": "專案名稱",
  "dialog.createProject.namePlaceholder": "my-project",
  "dialog.createProject.nameHint": "僅支援字母、數字、連字號和底線，不能有空格。",
  "dialog.createProject.nameRequired": "請輸入專案名稱",
  "dialog.createProject.duplicate": '"{{path}}" 處已存在同名專案',
  "dialog.createProject.zipLabel": "從 Zip 資料夾建立（選用）",
  "dialog.createProject.zipDropzone": "將 zip 檔案拖放到此處或按一下瀏覽",
  "dialog.createProject.zipMaxSize": "zip 最大大小：200MB",
  "dialog.createProject.zipTooLarge": "zip 檔案大小必須小於 {{size}}MB",
  "dialog.createProject.step.directory": "正在建立專案目錄...",
  "dialog.createProject.step.git": "正在初始化 git 儲存庫...",
  "dialog.createProject.step.zip": "正在解壓縮 zip 檔案...",
  "dialog.createProject.step.opening": "正在開啟專案...",
  "dialog.createProject.step.cleanup": "正在清理...",
  "dialog.createProject.error.zipExtract": "解壓縮 zip 檔案失敗",
  "dialog.createProject.error.createFailed": "建立專案失敗",
  "session.panel.collapseToReview": "摺疊以審查",
  "session.panel.restoreSplitView": "還原分割檢視",
  "allProjects.view.grid": "格線檢視",
  "allProjects.view.list": "清單檢視",
  "auth.login.stealthMode": "隱身模式",
  "session.prompt.disclaimer": "O M A I + 是人工智慧，可能會犯錯。請仔細核對回覆。",
