export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "O M A I +에서 제공하는 무료 모델",
  ...
  "provider.connect.apiKey.description":
    "{{provider}} API 키를 입력하여 계정을 연결하고 O M A I +에서 {{provider}} 모델을 사용하세요.",
  ...
  "provider.connect.opencodeZen.line1":
    "O M A I + Zen은 코딩 에이전트를 위해 최적화된 신뢰할 수 있는 엄선된 모델에 대한 액세스를 제공합니다.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    "를 방문하여 인증 코드를 받아 계정을 연결하고 O M A I +에서 {{provider}} 모델을 사용하세요.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    "를 방문하고 아래 코드를 입력하여 계정을 연결하고 O M A I +에서 {{provider}} 모델을 사용하세요.",
  ...
  "dialog.mcp.empty": "MCP가 구성되지 않았습니다",
  "dialog.mcp.hint": "프로젝트를 열면 세션 상태 표시기에 MCP 서버 상태가 표시됩니다.",
  ...
  "dialog.server.description": "이 앱이 연결할 O M A I + 서버를 전환합니다.",
  ...
  "toast.update.description": "O M A I +의 새 버전({{version}})을 설치할 수 있습니다.",
  ...
  "error.page.report.prefix": "이 오류를 O M A I + 팀에 제보해 주세요: ",
  ...
  "error.chain.mcpFailed": 'MCP 서버 "{{name}}" 실패. 참고: O M A I +는 아직 MCP 인증을 지원하지 않습니다.',
  ...
  "sidebar.gettingStarted.line1": "O M A I +에는 무료 모델이 포함되어 있어 즉시 시작할 수 있습니다.",
  ...
  "settings.desktop.wsl.description": "Windows의 WSL 내부에서 O M A I + 서버를 실행합니다.",
  ...
  "settings.general.row.language.description": "O M A I + 표시 언어 변경",
  "settings.general.row.appearance.title": "모양",
  "settings.general.row.appearance.description": "기기에서 O M A I +가 보이는 방식 사용자 지정",
  "settings.general.row.colorScheme.title": "색상 테마",
  "settings.general.row.colorScheme.description": "O M A I +가 시스템, 라이트 또는 다크 테마를 따를지 선택하세요",
  "settings.general.row.theme.title": "테마",
  "settings.general.row.theme.description": "O M A I + 테마 사용자 지정",
  ...
  "settings.updates.row.startup.description": "O M A I +를 실행할 때 업데이트를 자동으로 확인합니다",
  ...
  "settings.updates.toast.latest.description": "현재 최신 버전의 O M A I +를 사용 중입니다.",
  ...
  "session.question.answeredProgress": "{{total}}개 중 {{answered}}개 답변됨",
  "session.question.custom.placeholder": "직접 답변을 작성하세요...",
  ...
  "session.question.pendingAnswer": "질문에 답해 주세요",
  ...
  "wsl.onboarding.checkingOpencode": "O M A I + 확인 중...",
  "wsl.onboarding.checkingOpencodeIn": "{{distro}}에서 O M A I + 확인 중...",
  "wsl.onboarding.updatingOpencode": "O M A I + 업데이트 중...",
  "wsl.onboarding.updatingOpencodeIn": "{{distro}}에서 O M A I + 업데이트 중...",
  "wsl.onboarding.updateOpencodeIn": "{{distro}}에서 O M A I +를 업데이트하세요.",
  "wsl.onboarding.updateOpencode": "O M A I + 업데이트",
  "wsl.onboarding.opencodeReadyIn": "{{distro}}에서 O M A I +를 사용할 준비가 되었습니다.",
  "wsl.onboarding.opencodeReady": "O M A I +가 준비되었습니다.",
  "wsl.onboarding.installOpencodeIn": "{{distro}}에 O M A I +를 설치하세요.",
  "wsl.onboarding.installOpencode": "O M A I + 설치",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "O M A I +가 설치되지 않음",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "O M A I +에서 WSL 서버를 추가하려면 WSL (Windows Subsystem for Linux)이 필요합니다",
  "wsl.onboarding.wslUnavailable.title": "WSL을 사용할 수 없음",
  "wsl.onboarding.wslUnavailable.description": "O M A I +에서 이 컴퓨터의 WSL을 확인할 수 없습니다.",
  "wsl.onboarding.installWsl": "WSL 설치",
  "wsl.onboarding.windowsRestartRequired": "WSL 설치를 완료하려면 Windows를 다시 시작한 다음 O M A I +를 다시 여세요.",
  ...
  "preview.starting": "미리보기 시작 중...",
  "preview.loading": "미리보기 로딩 중...",
  "preview.title": "미리보기",

  "preview.error.loadFailed": "미리보기를 로드하지 못했습니다.",
  "preview.action.reload": "새로고침",
  "preview.action.reloadPreview": "미리보기 새로고침",
  "preview.action.openInBrowser": "브라우저에서 열기",
  "dialog.createProject.title": "프로젝트 만들기",
  "dialog.createProject.creating": "프로젝트 만드는 중...",
  "dialog.createProject.nameLabel": "프로젝트 이름",
  "dialog.createProject.namePlaceholder": "my-project",
  "dialog.createProject.nameHint": "문자, 숫자, 하이픈, 밑줄만 사용 가능. 공백 없음.",
  "dialog.createProject.nameRequired": "프로젝트 이름을 입력하세요",
  "dialog.createProject.duplicate": '"{{path}}"에 이미 프로젝트가 있습니다',
  "dialog.createProject.zipLabel": "Zip 폴더에서 만들기 (선택사항)",
  "dialog.createProject.zipDropzone": "zip 파일을 여기에 드롭하거나 클릭하여 찾아보기",
  "dialog.createProject.zipMaxSize": "최대 zip 크기: 200MB",
  "dialog.createProject.zipTooLarge": "zip 파일은 {{size}}MB 이하여야 합니다",
  "dialog.createProject.step.directory": "프로젝트 디렉토리 만드는 중...",
  "dialog.createProject.step.git": "git 저장소 초기화 중...",
  "dialog.createProject.step.zip": "zip 파일 압축 해제 중...",
  "dialog.createProject.step.opening": "프로젝트 여는 중...",
  "dialog.createProject.step.cleanup": "정리 중...",
  "dialog.createProject.error.zipExtract": "zip 파일 압축 해제 실패",
  "dialog.createProject.error.createFailed": "프로젝트 만들기 실패",
  "session.panel.collapseToReview": "검토로 접기",
  "session.panel.restoreSplitView": "분할 보기 복원",
  "allProjects.view.grid": "그리드 보기",
  "allProjects.view.list": "목록 보기",
  "auth.login.stealthMode": "스텔스 모드",
  "session.prompt.disclaimer": "O M A I +는 AI이며 실수를 할 수 있습니다. 응답을 다시 확인하세요.",
}
