export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "O M A I +が提供する無料モデル",
  ...
  "provider.connect.apiKey.description":
    "{{provider}}のAPIキーを入力してアカウントを接続し、O M A I +で{{provider}}モデルを使用します。",
  ...
  "provider.connect.opencodeZen.line1":
    "O M A I + Zenは、コーディングエージェント向けに最適化された信頼性の高いモデルへのアクセスを提供します。",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " にアクセスして認証コードを取得し、アカウントを接続してO M A I +で{{provider}}モデルを使用してください。",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " にアクセスし、以下のコードを入力してアカウントを接続し、O M A I +で{{provider}}モデルを使用してください。",
  ...
  "session.question.pendingAnswer": "質問にお答えください",
  ...
  "dialog.mcp.hint": "プロジェクトを開くと、セッションのステータスインジケーターに MCP サーバーのステータスが表示されます。",
  ...
  "dialog.server.description": "このアプリが接続するO M A I +サーバーを切り替えます。",
  ...
  "wsl.onboarding.checkingOpencode": "O M A I +を確認中...",
  "wsl.onboarding.checkingOpencodeIn": "{{distro}}内のO M A I +を確認中...",
  "wsl.onboarding.updatingOpencode": "O M A I +を更新中...",
  "wsl.onboarding.updatingOpencodeIn": "{{distro}}内のO M A I +を更新中...",
  "wsl.onboarding.updateOpencodeIn": "{{distro}}内のO M A I +を更新してください。",
  "wsl.onboarding.updateOpencode": "O M A I +を更新",
  "wsl.onboarding.opencodeReadyIn": "{{distro}}内のO M A I +の準備ができました。",
  "wsl.onboarding.opencodeReady": "O M A I +の準備ができました。",
  "wsl.onboarding.installOpencodeIn": "{{distro}}にO M A I +をインストールしてください。",
  "wsl.onboarding.installOpencode": "O M A I +をインストール",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "O M A I +がインストールされていません",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "O M A I +でWSLサーバーを追加するには、WSL (Windows Subsystem for Linux) が必要です",
  ...
  "wsl.onboarding.windowsRestartRequired":
    "WSLのインストールを完了するにはWindowsを再起動し、O M A I +をもう一度開いてください。",
  ...
  "toast.update.description": "O M A I +の新しいバージョン ({{version}}) がインストール可能です。",
  ...
  "error.page.report.prefix": "このエラーをO M A I +チームに報告してください: ",
  ...
  "error.chain.mcpFailed": 'MCPサーバー "{{name}}" が失敗しました。注意: O M A I +はまだMCP認証をサポートしていません。',
  ...
  "sidebar.gettingStarted.line1": "O M A I +には無料モデルが含まれているため、すぐに開始できます。",
  ...
  "settings.desktop.wsl.description": "WindowsのWSL環境でO M A I +サーバーを実行します。",
  ...
  "settings.general.row.language.description": "O M A I +の表示言語を変更します",
  ...
  "settings.general.row.appearance.description": "デバイスでのO M A I +の表示をカスタマイズします",
  "settings.general.row.colorScheme.title": "配色",
  "settings.general.row.colorScheme.description": "O M A I +がシステム、ライト、またはダークテーマに従うかを選択します",
  "settings.general.row.theme.title": "テーマ",
  "settings.general.row.theme.description": "O M A I +のテーマをカスタマイズします。",
  ...
  "settings.updates.row.startup.description": "O M A I + の起動時に自動でアップデートを確認します",
  ...
  "settings.updates.toast.latest.description": "O M A I + は最新バージョンです。",
  ...
  "session.question.answeredProgress": "{{total}} 問中 {{answered}} 問に回答済み",
  "session.question.custom.placeholder": "自由な回答を入力...",
  ...
  "preview.starting": "プレビューを開始中...",
  "preview.loading": "プレビューを読み込み中...",
  "preview.title": "プレビュー",

  "preview.error.loadFailed": "プレビューの読み込みに失敗しました。",
  "preview.action.reload": "再読み込み",
  "preview.action.reloadPreview": "プレビューを再読み込み",
  "preview.action.openInBrowser": "ブラウザで開く",
  "dialog.createProject.title": "プロジェクトを作成",
  "dialog.createProject.creating": "プロジェクトを作成中...",
  "dialog.createProject.nameLabel": "プロジェクト名",
  "dialog.createProject.namePlaceholder": "my-project",
  "dialog.createProject.nameHint": "英字、数字、ハイフン、アンダースコアのみ。スペース不可。",
  "dialog.createProject.nameRequired": "プロジェクト名を入力してください",
  "dialog.createProject.duplicate": '"{{path}}"にプロジェクトが既に存在します',
  "dialog.createProject.zipLabel": "Zipフォルダから作成（オプション）",
  "dialog.createProject.zipDropzone": "zipファイルをここにドロップまたはクリックして参照",
  "dialog.createProject.zipMaxSize": "zip最大サイズ: 200MB",
  "dialog.createProject.zipTooLarge": "zipファイルは{{size}}MB以下である必要があります",
  "dialog.createProject.step.directory": "プロジェクトディレクトリを作成中...",
  "dialog.createProject.step.git": "gitリポジトリを初期化中...",
  "dialog.createProject.step.zip": "zipファイルを展開中...",
  "dialog.createProject.step.opening": "プロジェクトを開いています...",
  "dialog.createProject.step.cleanup": "クリーンアップ中...",
  "dialog.createProject.error.zipExtract": "zipファイルの展開に失敗しました",
  "dialog.createProject.error.createFailed": "プロジェクトの作成に失敗しました",
  "session.panel.collapseToReview": "レビューに折りたたむ",
  "session.panel.restoreSplitView": "分割表示を復元",
  "allProjects.view.grid": "グリッド表示",
  "allProjects.view.list": "リスト表示",
  "auth.login.stealthMode": "ステルスモード",
  "session.prompt.disclaimer": "O M A I +はAIであり、間違いを犯す可能性があります。回答を再確認してください。",
}
