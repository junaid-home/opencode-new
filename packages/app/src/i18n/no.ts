...
export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller levert av O M A I +",
  ...
  "provider.connect.apiKey.description":
    "Skriv inn din {{provider}} API-nøkkel for å koble til kontoen din og bruke {{provider}}-modeller i O M A I +.",
  ...
  "provider.connect.opencodeZen.line1":
    "O M A I + Zen gir deg tilgang til et utvalg av pålitelige optimaliserte modeller for kodeagenter.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " for å hente autorisasjonskoden din for å koble til kontoen din og bruke {{provider}}-modeller i O M A I +.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og skriv inn koden nedenfor for å koble til kontoen din og bruke {{provider}}-modeller i O M A I +.",
  ...
  "dialog.mcp.hint": "MCP-serverens status vises i øktstatusindikatoren når et prosjekt er åpent.",
  ...
  "dialog.server.description": "Bytt hvilken O M A I +-server denne appen kobler til.",
  ...
  "toast.update.description": "En ny versjon av O M A I + ({{version}}) er nå tilgjengelig for installasjon.",
  ...
  "error.page.report.prefix": "Vennligst rapporter denne feilen til O M A I +-teamet",
  ...
  "error.chain.mcpFailed": 'MCP-server "{{name}}" mislyktes. Merk at O M A I + ikke støtter MCP-autentisering ennå.',
  ...
  "sidebar.gettingStarted.line1": "O M A I + inkluderer gratis modeller så du kan starte umiddelbart.",
  ...
  "settings.desktop.wsl.description": "Kjør O M A I +-serveren i WSL på Windows.",
  ...
  "settings.general.row.language.description": "Endre visningsspråket for O M A I +",
  "settings.general.row.appearance.title": "Utseende",
  "settings.general.row.appearance.description": "Tilpass hvordan O M A I + ser ut på enheten din",
  "settings.general.row.colorScheme.title": "Fargevalg",
  "settings.general.row.colorScheme.description": "Velg om O M A I + skal følge systemets, lyst eller mørkt tema",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpass hvordan O M A I + er tematisert.",
  ...
  "settings.updates.row.startup.description": "Se automatisk etter oppdateringer når O M A I + starter",
  ...
  "settings.updates.toast.latest.description": "Du bruker den nyeste versjonen av O M A I +.",
  ...
  "session.question.answeredProgress": "{{answered}} av {{total}} besvart",
  "session.question.custom.placeholder": "Skriv et eget svar...",
  ...
  "session.question.pendingAnswer": "Vennligst svar på spørsmålene",
  ...
  "wsl.onboarding.checkingOpencode": "Sjekker O M A I +...",
  "wsl.onboarding.checkingOpencodeIn": "Sjekker O M A I + i {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Oppdaterer O M A I +...",
  "wsl.onboarding.updatingOpencodeIn": "Oppdaterer O M A I + i {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Oppdater O M A I + i {{distro}}.",
  "wsl.onboarding.updateOpencode": "Oppdater O M A I +",
  "wsl.onboarding.opencodeReadyIn": "O M A I + er klar i {{distro}}.",
  "wsl.onboarding.opencodeReady": "O M A I + er klar.",
  "wsl.onboarding.installOpencodeIn": "Installer O M A I + i {{distro}}.",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "O M A I + er ikke installert",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) kreves før O M A I + kan legge til en WSL-server",
  "wsl.onboarding.wslUnavailable.title": "WSL er utilgjengelig",
  "wsl.onboarding.wslUnavailable.description": "O M A I + kunne ikke bekrefte WSL på denne maskinen.",
  "wsl.onboarding.installWsl": "Installer WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Start Windows på nytt for å fullføre installasjonen av WSL, og åpne deretter O M A I + på nytt.",
  ...
  "preview.starting": "Starter forhåndsvisning...",
  "preview.loading": "Laster forhåndsvisning...",
  "preview.title": "Forhåndsvisning",

  "preview.error.loadFailed": "Kunne ikke laste forhåndsvisning.",
  "preview.action.reload": "Last på nytt",
  "preview.action.reloadPreview": "Last forhåndsvisning på nytt",
  "preview.action.openInBrowser": "Åpne i nettleser",
  "dialog.createProject.title": "Opprett prosjekt",
  "dialog.createProject.creating": "Oppretter prosjekt...",
  "dialog.createProject.nameLabel": "Prosjektnavn",
  "dialog.createProject.namePlaceholder": "mitt-prosjekt",
  "dialog.createProject.nameHint": "Kun bokstaver, tall, bindestreker og understreker. Ingen mellomrom.",
  "dialog.createProject.nameRequired": "Vennligst skriv inn et prosjektnavn",
  "dialog.createProject.duplicate": 'Et prosjekt finnes allerede på "{{path}}"',
  "dialog.createProject.zipLabel": "Opprett fra Zip-mappe (valgfritt)",
  "dialog.createProject.zipDropzone": "Slipp zip-fil her eller klikk for å bla",
  "dialog.createProject.zipMaxSize": "Maks zip-størrelse: 200MB",
  "dialog.createProject.zipTooLarge": "Zip-filen må være under {{size}}MB",
  "dialog.createProject.step.directory": "Oppretter prosjektkatalog...",
  "dialog.createProject.step.git": "Initialiserer git-repository...",
  "dialog.createProject.step.zip": "Pakker ut zip-fil...",
  "dialog.createProject.step.opening": "Åpner prosjekt...",
  "dialog.createProject.step.cleanup": "Rydder opp...",
  "dialog.createProject.error.zipExtract": "Kunne ikke pakke ut zip-fil",
  "dialog.createProject.error.createFailed": "Kunne ikke opprette prosjekt",
  "session.panel.collapseToReview": "Fold sammen for gjennomgang",
  "session.panel.restoreSplitView": "Gjenopprett delt visning",
  "allProjects.view.grid": "Rutenettvisning",
  "allProjects.view.list": "Listevisning",
  "auth.login.stealthMode": "SKJULT MODUS",
  "session.prompt.disclaimer": "O M A I + er AI og kan gjøre feil. Vennligst dobbeltsjekk svarene.",
