export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Безкоштовні моделі від O M A I +",
  ...
  "provider.connect.apiKey.description":
    "Введіть ключ API {{provider}}, щоб підключити обліковий запис і використовувати моделі {{provider}} у O M A I +.",
  ...
  "provider.connect.opencodeZen.line1":
    "O M A I + Zen надає доступ до відібраного набору надійних оптимізованих моделей для агентів кодування.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    ", щоб отримати код авторизації, підключити обліковий запис і використовувати моделі {{provider}} у O M A I +.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " і введіть код нижче, щоб підключити обліковий запис і використовувати моделі {{provider}} у O M A I +.",
  ...
  "session.question.pendingAnswer": "Будь ласка, дайте відповіді на запитання",
  ...
  "dialog.mcp.empty": "Налаштування MCP відсутні",
  "dialog.mcp.hint": "Статус MCP-сервера відображається в індикаторі статусу сесії при відкритті проєкту.",
  ...
  "dialog.server.description": "Перемкніть сервер O M A I +, до якого підключається ця програма.",
  ...
  "wsl.onboarding.checkingOpencode": "Перевірка O M A I +...",
  "wsl.onboarding.checkingOpencodeIn": "Перевірка O M A I + у {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Оновлення O M A I +...",
  "wsl.onboarding.updatingOpencodeIn": "Оновлення O M A I + у {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Оновіть O M A I + у {{distro}}.",
  "wsl.onboarding.updateOpencode": "Оновити O M A I +",
  "wsl.onboarding.opencodeReadyIn": "O M A I + готовий до роботи у {{distro}}.",
  "wsl.onboarding.opencodeReady": "O M A I + готовий до роботи.",
  "wsl.onboarding.installOpencodeIn": "Встановіть O M A I + у {{distro}}.",
  "wsl.onboarding.installOpencode": "Встановити O M A I +",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "O M A I + не встановлено",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Для додавання сервера WSL в O M A I + потрібна WSL (Підсистема Windows для Linux)",
  "wsl.onboarding.wslUnavailable.title": "WSL недоступна",
  "wsl.onboarding.wslUnavailable.description": "O M A I + не вдалося перевірити WSL на цьому комп'ютері.",
  "wsl.onboarding.installWsl": "Встановити WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Перезапустіть Windows, щоб завершити встановлення WSL, а потім знову відкрийте O M A I +.",
  ...
  "toast.update.description": "Нова версія O M A I + ({{version}}) тепер доступна для встановлення.",
  ...
  "error.page.report.prefix": "Будь ласка, повідомте про цю помилку команді O M A I +",
  ...
  "error.chain.mcpFailed":
    'Сервер MCP "{{name}}" не працює. Зверніть увагу, O M A I + ще не підтримує автентифікацію MCP.',
  ...
  "session.question.answeredProgress": "Відповідей: {{answered}} з {{total}}",
  "session.question.custom.placeholder": "Напишіть власну відповідь...",
  ...
  "sidebar.gettingStarted.line1": "O M A I + містить безкоштовні моделі, тому ви можете почати негайно.",
  ...
  "settings.desktop.wsl.description": "Запускати сервер O M A I + всередині WSL на Windows.",
  ...
  "settings.general.row.language.description": "Змінити мову інтерфейсу O M A I +",
  ...
  "settings.general.row.appearance.description": "Налаштуйте вигляд O M A I + на вашому пристрої",
  "settings.general.row.colorScheme.title": "Кольорова схема",
  "settings.general.row.colorScheme.description": "Виберіть, чи O M A I + використовує системну, світлу або темну тему",
  "settings.general.row.theme.title": "Тема",
  "settings.general.row.theme.description": "Налаштуйте тему O M A I +.",
  ...
  "settings.updates.row.startup.description": "Автоматично перевіряти наявність оновлень під час запуску O M A I +",
  ...
  "settings.updates.toast.latest.description": "Ви використовуєте останню версію O M A I +.",
  ...
  "preview.starting": "Запуск попереднього перегляду...",
  "preview.loading": "Завантаження попереднього перегляду...",
  "preview.title": "Попередній перегляд",

  "preview.error.loadFailed": "Не вдалося завантажити попередній перегляд.",
  "preview.action.reload": "Перезавантажити",
  "preview.action.reloadPreview": "Перезавантажити попередній перегляд",
  "preview.action.openInBrowser": "Відкрити у браузері",
  "dialog.createProject.title": "Створити проєкт",
  "dialog.createProject.creating": "Створення проєкту...",
  "dialog.createProject.nameLabel": "Назва проєкту",
  "dialog.createProject.namePlaceholder": "мій-проєкт",
  "dialog.createProject.nameHint": "Лише літери, цифри, дефіси та підкреслення. Без пробілів.",
  "dialog.createProject.nameRequired": "Будь ласка, введіть назву проєкту",
  "dialog.createProject.duplicate": 'Проєкт уже існує в "{{path}}"',
  "dialog.createProject.zipLabel": "Створити з папки Zip (необов'язково)",
  "dialog.createProject.zipDropzone": "Перетягніть zip-файл сюди або натисніть для перегляду",
  "dialog.createProject.zipMaxSize": "Максимальний розмір zip: 200МБ",
  "dialog.createProject.zipTooLarge": "Розмір zip-файлу має бути менше {{size}}МБ",
  "dialog.createProject.step.directory": "Створення каталогу проєкту...",
  "dialog.createProject.step.git": "Ініціалізація git-репозиторію...",
  "dialog.createProject.step.zip": "Вилучення zip-файлу...",
  "dialog.createProject.step.opening": "Відкриття проєкту...",
  "dialog.createProject.step.cleanup": "Очищення...",
  "dialog.createProject.error.zipExtract": "Не вдалося вилучити zip-файл",
  "dialog.createProject.error.createFailed": "Не вдалося створити проєкт",
  "session.panel.collapseToReview": "Згорнути для перегляду",
  "session.panel.restoreSplitView": "Відновити розділений вигляд",
  "allProjects.view.grid": "Вигляд сіткою",
  "allProjects.view.list": "Вигляд списком",
  "auth.login.stealthMode": "ПРИХОВАНИЙ РЕЖИМ",
  "session.prompt.disclaimer": "O M A I + — це ШІ і може помилятися. Будь ласка, перевіряйте відповіді.",
}
