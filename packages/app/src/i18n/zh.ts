...
export const dict = {
  ...
  "dialog.provider.opencode.note": "使用 O M A I + Zen 或 API 密钥连接",
  ...
  "dialog.model.unpaid.freeModels.title": "O M A I + 提供的免费模型",
  ...
  "provider.connect.apiKey.description":
    "输入你的 {{provider}} API 密钥以连接帐户，并在 O M A I + 中使用 {{provider}} 模型。",
  ...
  "provider.connect.opencodeZen.line1": "O M A I + Zen 为你提供一组精选的可靠优化模型，用于代码智能体。",
  ...
  "provider.connect.oauth.code.visit.suffix": " 获取授权码，以连接你的帐户并在 O M A I + 中使用 {{provider}} 模型。",
  ...
  "provider.connect.oauth.auto.visit.suffix": " 并输入以下代码，以连接你的帐户并在 O M A I + 中使用 {{provider}} 模型。",
  ...
  "session.question.pendingAnswer": "请回答问题。",
  ...
  "dialog.mcp.hint": "当项目打开时，MCP 服务器状态显示在会话状态指示器中。",
  ...
  "dialog.server.description": "切换此应用连接的 O M A I + 服务器。",
  ...
  "wsl.onboarding.checkingOpencode": "正在检查 O M A I +...",
  "wsl.onboarding.checkingOpencodeIn": "正在检查 {{distro}} 中的 O M A I +...",
  "wsl.onboarding.updatingOpencode": "正在更新 O M A I +...",
  "wsl.onboarding.updatingOpencodeIn": "正在更新 {{distro}} 中的 O M A I +...",
  "wsl.onboarding.updateOpencodeIn": "更新 {{distro}} 中的 O M A I +。",
  "wsl.onboarding.updateOpencode": "更新 O M A I +",
  "wsl.onboarding.opencodeReadyIn": "{{distro}} 中的 O M A I + 已就绪。",
  "wsl.onboarding.opencodeReady": "O M A I + 已就绪。",
  "wsl.onboarding.installOpencodeIn": "在 {{distro}} 中安装 O M A I +。",
  "wsl.onboarding.installOpencode": "安装 O M A I +",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "未安装 O M A I +",
  ...
  "wsl.onboarding.wslNotInstalled.description": "O M A I + 需要 WSL（Windows Subsystem for Linux）才能添加 WSL 服务器",
  "wsl.onboarding.wslUnavailable.title": "WSL 不可用",
  "wsl.onboarding.wslUnavailable.description": "O M A I + 无法验证此设备上的 WSL。",
  "wsl.onboarding.installWsl": "安装 WSL",
  "wsl.onboarding.windowsRestartRequired": "重启 Windows 以完成 WSL 安装，然后重新打开 O M A I +。",
  ...
  "toast.update.description": "O M A I + 有新版本 ({{version}}) 可安装。",
  ...
  "error.page.report.prefix": "请将此错误报告给 O M A I + 团队",
  ...
  "error.chain.mcpFailed": 'MCP 服务器 "{{name}}" 启动失败。注意: O M A I + 暂不支持 MCP 认证。',
  ...
  "sidebar.gettingStarted.line1": "O M A I + 提供免费模型，你可以立即开始使用。",
  ...
  "settings.desktop.wsl.description": "在 Windows 的 WSL 环境中运行 O M A I + 服务器。",
  ...
  "settings.general.row.language.description": "更改 O M A I + 的显示语言",
  ...
  "settings.general.row.appearance.description": "自定义 O M A I + 在你的设备上的外观",
  "settings.general.row.colorScheme.title": "配色方案",
  "settings.general.row.colorScheme.description": "选择 O M A I + 跟随系统、浅色或深色主题",
  "settings.general.row.theme.title": "主题",
  "settings.general.row.theme.description": "自定义 O M A I + 的主题。",
  ...
  "settings.updates.row.startup.description": "在 O M A I + 启动时自动检查更新",
  ...
  "settings.updates.toast.latest.description": "你正在使用最新版本的 O M A I +。",
  ...
  "session.question.answeredProgress": "已回答 {{answered}}/{{total}}",
  "session.question.custom.placeholder": "输入自定义答案...",
  ...
  "preview.error.loadFailed": "加载预览失败。",
  "preview.action.reload": "重新加载",
  "preview.action.reloadPreview": "重新加载预览",
  "preview.action.openInBrowser": "在浏览器中打开",
  "dialog.createProject.title": "创建项目",
  "dialog.createProject.creating": "正在创建项目...",
  "dialog.createProject.nameLabel": "项目名称",
  "dialog.createProject.namePlaceholder": "my-project",
  "dialog.createProject.nameHint": "仅支持字母、数字、连字符和下划线，不能有空格。",
  "dialog.createProject.nameRequired": "请输入项目名称",
  "dialog.createProject.duplicate": '"{{path}}" 处已存在同名项目',
  "dialog.createProject.zipLabel": "从 Zip 文件夹创建（可选）",
  "dialog.createProject.zipDropzone": "将 zip 文件拖放到此处或点击浏览",
  "dialog.createProject.zipMaxSize": "zip 最大大小：200MB",
  "dialog.createProject.zipTooLarge": "zip 文件大小必须小于 {{size}}MB",
  "dialog.createProject.step.directory": "正在创建项目目录...",
  "dialog.createProject.step.git": "正在初始化 git 仓库...",
  "dialog.createProject.step.zip": "正在解压 zip 文件...",
  "dialog.createProject.step.opening": "正在打开项目...",
  "dialog.createProject.step.cleanup": "正在清理...",
  "dialog.createProject.error.zipExtract": "解压 zip 文件失败",
  "dialog.createProject.error.createFailed": "创建项目失败",
  "session.panel.collapseToReview": "折叠以审查",
  "session.panel.restoreSplitView": "恢复分栏视图",
  "allProjects.view.grid": "网格视图",
  "allProjects.view.list": "列表视图",
  "auth.login.stealthMode": "隐身模式",
  "session.prompt.disclaimer": "O M A I + 是人工智能，可能会犯错误。请仔细核对回复。",
