...
export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Kostenlose Modelle von O M A I +",
  ...
  "provider.connect.apiKey.description":
    "Geben Sie Ihren {{provider}} API-Schlüssel ein, um Ihr Konto zu verbinden und {{provider}} Modelle in O M A I + zu nutzen.",
  ...
  "provider.connect.opencodeZen.line1":
    "O M A I + Zen bietet Ihnen Zugriff auf eine kuratierte Auswahl zuverlässiger, optimierter Modelle für Coding-Agenten.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    ", um Ihren Autorisierungscode zu erhalten, Ihr Konto zu verbinden und {{provider}} Modelle in O M A I + zu nutzen.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " und geben Sie den untenstehenden Code ein, um Ihr Konto zu verbinden und {{provider}} Modelle in O M A I + zu nutzen.",
  ...
  "session.question.pendingAnswer": "Bitte beantworten Sie die Fragen",
  ...
  "dialog.mcp.hint": "Der MCP-Server-Status wird im Sitzungsstatusanzeige angezeigt, wenn ein Projekt geöffnet ist.",
  ...
  "dialog.server.description": "Wechseln Sie den O M A I +-Server, mit dem sich diese App verbindet.",
  ...
  "wsl.onboarding.checkingOpencode": "O M A I + wird geprüft...",
  "wsl.onboarding.checkingOpencodeIn": "O M A I + in {{distro}} wird geprüft...",
  "wsl.onboarding.updatingOpencode": "O M A I + wird aktualisiert...",
  "wsl.onboarding.updatingOpencodeIn": "O M A I + in {{distro}} wird aktualisiert...",
  "wsl.onboarding.updateOpencodeIn": "Aktualisieren Sie O M A I + in {{distro}}.",
  "wsl.onboarding.updateOpencode": "O M A I + aktualisieren",
  "wsl.onboarding.opencodeReadyIn": "O M A I + ist in {{distro}} bereit.",
  "wsl.onboarding.opencodeReady": "O M A I + ist bereit.",
  "wsl.onboarding.installOpencodeIn": "Installieren Sie O M A I + in {{distro}}.",
  "wsl.onboarding.installOpencode": "O M A I + installieren",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "O M A I + nicht installiert",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) ist erforderlich, bevor O M A I + einen WSL-Server hinzufügen kann",
  "wsl.onboarding.wslUnavailable.title": "WSL nicht verfügbar",
  "wsl.onboarding.wslUnavailable.description": "O M A I + konnte WSL auf diesem Computer nicht überprüfen.",
  "wsl.onboarding.installWsl": "WSL installieren",
  "wsl.onboarding.windowsRestartRequired":
    "Starten Sie Windows neu, um die WSL-Installation abzuschließen, und öffnen Sie dann O M A I + erneut.",
  ...
  "toast.update.description": "Eine neue Version von O M A I + ({{version}}) ist zur Installation verfügbar.",
  ...
  "error.page.report.prefix": "Bitte melden Sie diesen Fehler dem O M A I +-Team",
  ...
  "error.chain.mcpFailed":
    'MCP-Server "{{name}}" fehlgeschlagen. Hinweis: O M A I + unterstützt noch keine MCP-Authentifizierung.',
  ...
  "sidebar.gettingStarted.line1": "O M A I + enthält kostenlose Modelle, damit Sie sofort loslegen können.",
  ...
  "settings.desktop.wsl.description": "O M A I +-Server innerhalb von WSL unter Windows ausführen.",
  ...
  "settings.general.row.language.description": "Die Anzeigesprache für O M A I + ändern",
  ...
  "settings.general.row.appearance.description": "Anpassen, wie O M A I + auf Ihrem Gerät aussieht",
  "settings.general.row.colorScheme.title": "Farbschema",
  "settings.general.row.colorScheme.description":
    "Wählen Sie, ob O M A I + dem System-, hellen oder dunklen Thema folgt",
  "settings.general.row.theme.title": "Thema",
  "settings.general.row.theme.description": "Das Thema von O M A I + anpassen.",
  ...
  "settings.updates.row.startup.description": "Beim Start von O M A I + automatisch nach Updates suchen",
  ...
  "settings.updates.toast.latest.description": "Du verwendest die aktuelle Version von O M A I +.",
  ...
  "session.question.answeredProgress": "{{answered}} von {{total}} beantwortet",
  "session.question.custom.placeholder": "Eigene Antwort schreiben...",
  ...
  "preview.starting": "Vorschau wird gestartet...",
  "preview.loading": "Vorschau wird geladen...",
  "preview.title": "Vorschau",

  "preview.error.loadFailed": "Vorschau konnte nicht geladen werden.",
  "preview.action.reload": "Neu laden",
  "preview.action.reloadPreview": "Vorschau neu laden",
  "preview.action.openInBrowser": "Im Browser öffnen",
  "dialog.createProject.title": "Projekt erstellen",
  "dialog.createProject.creating": "Projekt wird erstellt...",
  "dialog.createProject.nameLabel": "Projektname",
  "dialog.createProject.namePlaceholder": "mein-projekt",
  "dialog.createProject.nameHint": "Nur Buchstaben, Zahlen, Bindestriche und Unterstriche. Keine Leerzeichen.",
  "dialog.createProject.nameRequired": "Bitte geben Sie einen Projektnamen ein",
  "dialog.createProject.duplicate": 'Ein Projekt existiert bereits unter "{{path}}"',
  "dialog.createProject.zipLabel": "Aus Zip-Ordner erstellen (optional)",
  "dialog.createProject.zipDropzone": "Zip-Datei hier ablegen oder klicken zum Durchsuchen",
  "dialog.createProject.zipMaxSize": "Maximale Zip-Größe: 200MB",
  "dialog.createProject.zipTooLarge": "Zip-Datei muss unter {{size}}MB sein",
  "dialog.createProject.step.directory": "Projektverzeichnis wird erstellt...",
  "dialog.createProject.step.git": "Git-Repository wird initialisiert...",
  "dialog.createProject.step.zip": "Zip-Datei wird extrahiert...",
  "dialog.createProject.step.opening": "Projekt wird geöffnet...",
  "dialog.createProject.step.cleanup": "Aufräumen...",
  "dialog.createProject.error.zipExtract": "Zip-Datei konnte nicht extrahiert werden",
  "dialog.createProject.error.createFailed": "Projekt konnte nicht erstellt werden",
  "session.panel.collapseToReview": "Zur Überprüfung zusammenfalten",
  "session.panel.restoreSplitView": "Geteilte Ansicht wiederherstellen",
  "allProjects.view.grid": "Rasteransicht",
  "allProjects.view.list": "Listenansicht",
  "auth.login.stealthMode": "GETARNTMODUS",
  "session.prompt.disclaimer": "O M A I + ist KI und kann Fehler machen. Bitte überprüfen Sie die Antworten.",
