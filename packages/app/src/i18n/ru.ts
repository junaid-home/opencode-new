export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Бесплатные модели от O M A I +",
  ...
  "provider.connect.apiKey.description":
    "Введите ваш API ключ {{provider}} для подключения аккаунта и использования моделей {{provider}} в O M A I +.",
  ...
  "provider.connect.opencodeZen.line1":
    "O M A I + Zen даёт вам доступ к отобранным надёжным оптимизированным моделям для агентов программирования.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " чтобы получить код авторизации для подключения аккаунта и использования моделей {{provider}} в O M A I +.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " и введите код ниже для подключения аккаунта и использования моделей {{provider}} в O M A I +.",
  ...
  "session.question.pendingAnswer": "Пожалуйста, ответьте на вопросы",
  ...
  "dialog.mcp.hint": "Статус MCP-сервера отображается в индикаторе статуса сеанса при открытии проекта.",
  ...
  "dialog.server.description": "Переключите сервер O M A I + к которому подключается приложение.",
  ...
  "wsl.onboarding.checkingOpencode": "Проверка O M A I +...",
  "wsl.onboarding.checkingOpencodeIn": "Проверка O M A I + в {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Обновление O M A I +...",
  "wsl.onboarding.updatingOpencodeIn": "Обновление O M A I + в {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Обновите O M A I + в {{distro}}.",
  "wsl.onboarding.updateOpencode": "Обновить O M A I +",
  "wsl.onboarding.opencodeReadyIn": "O M A I + в {{distro}} готов к работе.",
  "wsl.onboarding.opencodeReady": "O M A I + готов к работе.",
  "wsl.onboarding.installOpencodeIn": "Установите O M A I + в {{distro}}.",
  "wsl.onboarding.installOpencode": "Установить O M A I +",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "O M A I + не установлен",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Для добавления сервера WSL в O M A I + требуется WSL (Windows Subsystem for Linux)",
  "wsl.onboarding.wslUnavailable.title": "WSL недоступна",
  "wsl.onboarding.wslUnavailable.description": "O M A I + не смог проверить WSL на этом компьютере.",
  "wsl.onboarding.installWsl": "Установить WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Перезапустите Windows, чтобы завершить установку WSL, затем снова откройте O M A I +.",
  ...
  "toast.update.description": "Новая версия O M A I + ({{version}}) доступна для установки.",
  ...
  "error.page.report.prefix": "Пожалуйста, сообщите об этой ошибке команде O M A I +",
  ...
  "error.chain.mcpFailed":
    'MCP сервер "{{name}}" завершился с ошибкой. Обратите внимание, что O M A I + пока не поддерживает MCP авторизацию.',
  ...
  "sidebar.gettingStarted.line1": "O M A I + включает бесплатные модели, чтобы вы могли начать сразу.",
  ...
  "settings.desktop.wsl.description": "Запускать сервер O M A I + внутри WSL на Windows.",
  ...
  "settings.general.row.language.description": "Изменить язык отображения O M A I +",
  ...
  "settings.general.row.appearance.description": "Настройте как O M A I + выглядит на вашем устройстве",
  "settings.general.row.colorScheme.title": "Цветовая схема",
  "settings.general.row.colorScheme.description": "Выберите, следует ли O M A I + системной, светлой или тёмной теме",
  "settings.general.row.theme.title": "Тема",
  "settings.general.row.theme.description": "Настройте оформление O M A I +.",
  ...
  "settings.updates.row.startup.description": "Автоматически проверять обновления при запуске O M A I +",
  ...
  "settings.updates.toast.latest.description": "Вы используете последнюю версию O M A I +.",
  ...
  "session.question.answeredProgress": "{{answered}} из {{total}} отвечено",
  "session.question.custom.placeholder": "Напишите свой ответ...",
  ...
  "preview.starting": "Запуск предпросмотра...",
  "preview.loading": "Загрузка предпросмотра...",
  "preview.title": "Предпросмотр",

  "preview.error.loadFailed": "Не удалось загрузить предпросмотр.",
  "preview.action.reload": "Перезагрузить",
  "preview.action.reloadPreview": "Перезагрузить предпросмотр",
  "preview.action.openInBrowser": "Открыть в браузере",
  "dialog.createProject.title": "Создать проект",
  "dialog.createProject.creating": "Создание проекта...",
  "dialog.createProject.nameLabel": "Название проекта",
  "dialog.createProject.namePlaceholder": "мой-проект",
  "dialog.createProject.nameHint": "Только буквы, цифры, дефисы и подчёркивания. Без пробелов.",
  "dialog.createProject.nameRequired": "Пожалуйста, введите название проекта",
  "dialog.createProject.duplicate": 'Проект уже существует в "{{path}}"',
  "dialog.createProject.zipLabel": "Создать из папки Zip (необязательно)",
  "dialog.createProject.zipDropzone": "Перетащите zip-файл сюда или нажмите для просмотра",
  "dialog.createProject.zipMaxSize": "Максимальный размер zip: 200МБ",
  "dialog.createProject.zipTooLarge": "Размер zip-файла должен быть менее {{size}}МБ",
  "dialog.createProject.step.directory": "Создание директории проекта...",
  "dialog.createProject.step.git": "Инициализация git-репозитория...",
  "dialog.createProject.step.zip": "Извлечение zip-файла...",
  "dialog.createProject.step.opening": "Открытие проекта...",
  "dialog.createProject.step.cleanup": "Очистка...",
  "dialog.createProject.error.zipExtract": "Не удалось извлечь zip-файл",
  "dialog.createProject.error.createFailed": "Не удалось создать проект",
  "session.panel.collapseToReview": "Свернуть для просмотра",
  "session.panel.restoreSplitView": "Восстановить разделённый вид",
  "allProjects.view.grid": "Вид сеткой",
  "allProjects.view.list": "Вид списком",
  "auth.login.stealthMode": "СКРЫТЫЙ РЕЖИМ",
  "session.prompt.disclaimer": "O M A I + — это ИИ и может ошибаться. Пожалуйста, перепроверяйте ответы.",
}
