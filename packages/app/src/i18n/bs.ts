export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Besplatni modeli koje obezbjeđuje O M A I +",
  ...
  "provider.connect.apiKey.description":
    "Unesi svoj {{provider}} API ključ da povežeš račun i koristiš {{provider}} modele u O M A I +-u.",
  ...
  "provider.connect.opencodeZen.line1":
    "O M A I + Zen ti daje pristup kuriranom skupu pouzdanih, optimizovanih modela za coding agente.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " da preuzmeš autorizacijski kod i povežeš račun te koristiš {{provider}} modele u O M A I +-u.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i unesi kod ispod da povežeš račun i koristiš {{provider}} modele u O M A I +-u.",
  ...
  "session.question.pendingAnswer": "Molimo odgovorite na pitanja",
  ...
  "dialog.mcp.hint": "Status MCP servera se prikazuje u indikatoru statusa sesije kada je projekat otvoren.",
  ...
  "dialog.server.description": "Promijeni na koji se O M A I + server ova aplikacija povezuje.",
  ...
  "wsl.onboarding.checkingOpencode": "Provjera O M A I +...",
  "wsl.onboarding.checkingOpencodeIn": "Provjera O M A I + u distribuciji {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Ažuriranje O M A I +...",
  "wsl.onboarding.updatingOpencodeIn": "Ažuriranje O M A I + u distribuciji {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Ažuriraj O M A I + u distribuciji {{distro}}.",
  "wsl.onboarding.updateOpencode": "Ažuriraj O M A I +",
  "wsl.onboarding.opencodeReadyIn": "O M A I + je spreman u distribuciji {{distro}}.",
  "wsl.onboarding.opencodeReady": "O M A I + je spreman.",
  "wsl.onboarding.installOpencodeIn": "Instaliraj O M A I + u distribuciji {{distro}}.",
  "wsl.onboarding.installOpencode": "Instaliraj O M A I +",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "O M A I + nije instaliran",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) je potreban da bi O M A I + mogao dodati WSL server",
  "wsl.onboarding.wslUnavailable.title": "WSL nije dostupan",
  "wsl.onboarding.wslUnavailable.description": "O M A I + nije mogao provjeriti WSL na ovom uređaju.",
  "wsl.onboarding.installWsl": "Instaliraj WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Ponovo pokreni Windows da završiš instalaciju WSL-a, zatim ponovo otvori O M A I +.",
  ...
  "toast.update.description": "Nova verzija O M A I +-a ({{version}}) je dostupna za instalaciju.",
  ...
  "error.page.report.prefix": "Molimo prijavi ovu grešku O M A I + timu",
  ...
  "error.chain.mcpFailed": 'MCP server "{{name}}" nije uspio. Napomena: O M A I + još ne podržava MCP autentifikaciju.',
  ...
  "sidebar.gettingStarted.line1": "O M A I + uključuje besplatne modele, tako da možeš odmah početi.",
  ...
  "settings.desktop.wsl.description": "Pokreni O M A I + server unutar WSL-a na Windowsu.",
  ...
  "settings.general.row.language.description": "Promijeni jezik prikaza u O M A I +-u",
  ...
  "settings.general.row.appearance.description": "Prilagodi kako O M A I + izgleda na tvom uređaju",
  "settings.general.row.colorScheme.title": "Šema boja",
  "settings.general.row.colorScheme.description": "Odaberi da li O M A I + prati sistemsku, svijetlu ili tamnu temu",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Prilagodi temu O M A I +-a.",
  ...
  "settings.updates.row.startup.description": "Automatski provjerava ažuriranja kada se O M A I + pokrene",
  ...
  "settings.updates.toast.latest.description": "Koristiš najnoviju verziju O M A I +-a.",
  ...
  "session.question.answeredProgress": "{{answered}} od {{total}} odgovoreno",
  "session.question.custom.placeholder": "Napišite vlastiti odgovor...",
  ...
  "preview.starting": "Pokretanje pregleda...",
  "preview.loading": "Učitavanje pregleda...",
  "preview.title": "Pregled",

  "preview.error.loadFailed": "Neuspjelo učitavanje pregleda.",
  "preview.action.reload": "Ponovo učitaj",
  "preview.action.reloadPreview": "Ponovo učitaj pregled",
  "preview.action.openInBrowser": "Otvori u pregledniku",
  "dialog.createProject.title": "Kreiraj projekat",
  "dialog.createProject.creating": "Kreiranje projekta...",
  "dialog.createProject.nameLabel": "Naziv projekta",
  "dialog.createProject.namePlaceholder": "moj-projekat",
  "dialog.createProject.nameHint": "Samo slova, brojevi, crtice i podcrtice. Bez razmaka.",
  "dialog.createProject.nameRequired": "Molimo unesite naziv projekta",
  "dialog.createProject.duplicate": 'Projekat već postoji na "{{path}}"',
  "dialog.createProject.zipLabel": "Kreiraj iz Zip foldera (opcionalno)",
  "dialog.createProject.zipDropzone": "Otpustite zip datoteku ovdje ili kliknite za pregled",
  "dialog.createProject.zipMaxSize": "Maksimalna veličina zipa: 200MB",
  "dialog.createProject.zipTooLarge": "Zip datoteka mora biti manja od {{size}}MB",
  "dialog.createProject.step.directory": "Kreiranje direktorija projekta...",
  "dialog.createProject.step.git": "Inicijalizacija git repozitorija...",
  "dialog.createProject.step.zip": "Ekstrakcija zip datoteke...",
  "dialog.createProject.step.opening": "Otvaranje projekta...",
  "dialog.createProject.step.cleanup": "Čišćenje...",
  "dialog.createProject.error.zipExtract": "Neuspjela ekstrakcija zip datoteke",
  "dialog.createProject.error.createFailed": "Neuspjelo kreiranje projekta",
  "session.panel.collapseToReview": "Skupi za pregled",
  "session.panel.restoreSplitView": "Vrati podeljeni prikaz",
  "allProjects.view.grid": "Mrežni prikaz",
  "allProjects.view.list": "Prikaz liste",
  "auth.login.stealthMode": "PRIKRIVENI REŽIM",
  "session.prompt.disclaimer": "O M A I + je AI i može praviti greške. Molimo provjerite odgovore.",
}
