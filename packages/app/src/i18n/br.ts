export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Modelos gratuitos fornecidos pelo O M A I +",
  ...
  "provider.connect.apiKey.description":
    "Digite sua chave de API do {{provider}} para conectar sua conta e usar modelos do {{provider}} no O M A I +.",
  ...
  "provider.connect.opencodeZen.line1":
    "O M A I + Zen oferece acesso a um conjunto selecionado de modelos confiáveis otimizados para agentes de código.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " para obter seu código de autorização e conectar sua conta para usar modelos do {{provider}} no O M A I +.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e digite o código abaixo para conectar sua conta e usar modelos do {{provider}} no O M A I +.",
  ...
  "session.question.pendingAnswer": "Por favor, responda às perguntas",
  ...
  "dialog.mcp.hint": "O status do servidor MCP é exibido no indicador de status da sessão quando um projeto está aberto.",
  ...
  "dialog.server.description": "Trocar para qual servidor O M A I + este aplicativo se conecta.",
  ...
  "wsl.onboarding.checkingOpencode": "Verificando o O M A I +...",
  "wsl.onboarding.checkingOpencodeIn": "Verificando o O M A I + em {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Atualizando o O M A I +...",
  "wsl.onboarding.updatingOpencodeIn": "Atualizando o O M A I + em {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Atualize o O M A I + em {{distro}}.",
  "wsl.onboarding.updateOpencode": "Atualizar o O M A I +",
  "wsl.onboarding.opencodeReadyIn": "O O M A I + está pronto em {{distro}}.",
  "wsl.onboarding.opencodeReady": "O O M A I + está pronto.",
  "wsl.onboarding.installOpencodeIn": "Instale o O M A I + em {{distro}}.",
  "wsl.onboarding.installOpencode": "Instalar o O M A I +",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "O M A I + não instalado",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "O WSL (Windows Subsystem for Linux) é necessário para que o O M A I + possa adicionar um servidor WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL indisponível",
  "wsl.onboarding.wslUnavailable.description": "O O M A I + não conseguiu verificar o WSL neste computador.",
  "wsl.onboarding.installWsl": "Instalar o WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Reinicie o Windows para concluir a instalação do WSL e abra o O M A I + novamente.",
  ...
  "toast.update.description": "Uma nova versão do O M A I + ({{version}}) está disponível para instalação.",
  ...
  "error.page.report.prefix": "Por favor, reporte este erro para a equipe do O M A I +",
  ...
  "error.chain.mcpFailed": 'Servidor MCP "{{name}}" falhou. Nota: O M A I + ainda não suporta autenticação MCP.',
  ...
  "sidebar.gettingStarted.line1": "O M A I + inclui modelos gratuitos para você começar imediatamente.",
  ...
  "settings.desktop.wsl.description": "Executar o servidor O M A I + dentro do WSL no Windows.",
  ...
  "settings.general.row.language.description": "Alterar o idioma de exibição do O M A I +",
  ...
  "settings.general.row.appearance.description": "Personalize como o O M A I + aparece no seu dispositivo",
  "settings.general.row.colorScheme.title": "Esquema de cores",
  "settings.general.row.colorScheme.description": "Escolha se o O M A I + segue o tema do sistema, claro ou escuro",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personalize como o O M A I + é tematizado.",
  ...
  "settings.updates.row.startup.description": "Verificar atualizações automaticamente quando o O M A I + iniciar",
  ...
  "settings.updates.toast.latest.description": "Você está usando a versão mais recente do O M A I +.",
  ...
  "session.question.answeredProgress": "{{answered}} de {{total}} respondidas",
  "session.question.custom.placeholder": "Escreva uma resposta personalizada...",
  ...
  "preview.starting": "Iniciando visualização...",
  "preview.loading": "Carregando visualização...",
  "preview.title": "Visualização",

  "preview.error.loadFailed": "Falha ao carregar visualização.",
  "preview.action.reload": "Recarregar",
  "preview.action.reloadPreview": "Recarregar visualização",
  "preview.action.openInBrowser": "Abrir no navegador",
  "dialog.createProject.title": "Criar Projeto",
  "dialog.createProject.creating": "Criando projeto...",
  "dialog.createProject.nameLabel": "Nome do Projeto",
  "dialog.createProject.namePlaceholder": "meu-projeto",
  "dialog.createProject.nameHint": "Apenas letras, números, hífens e sublinhados. Sem espaços.",
  "dialog.createProject.nameRequired": "Por favor, insira um nome de projeto",
  "dialog.createProject.duplicate": 'Um projeto já existe em "{{path}}"',
  "dialog.createProject.zipLabel": "Criar a partir de pasta Zip (opcional)",
  "dialog.createProject.zipDropzone": "Solte o arquivo zip aqui ou clique para navegar",
  "dialog.createProject.zipMaxSize": "Tamanho máximo do zip: 200MB",
  "dialog.createProject.zipTooLarge": "O arquivo zip deve ter menos de {{size}}MB",
  "dialog.createProject.step.directory": "Criando diretório do projeto...",
  "dialog.createProject.step.git": "Inicializando repositório git...",
  "dialog.createProject.step.zip": "Extraindo arquivo zip...",
  "dialog.createProject.step.opening": "Abrindo projeto...",
  "dialog.createProject.step.cleanup": "Limpando...",
  "dialog.createProject.error.zipExtract": "Falha ao extrair arquivo zip",
  "dialog.createProject.error.createFailed": "Falha ao criar projeto",
  "session.panel.collapseToReview": "Recolher para revisar",
  "session.panel.restoreSplitView": "Restaurar visualização dividida",
  "allProjects.view.grid": "Visualização em grade",
  "allProjects.view.list": "Visualização em lista",
  "auth.login.stealthMode": "MODO OCULTO",
  "session.prompt.disclaimer": "O M A I + é IA e pode cometer erros. Verifique as respostas.",
}
