...
import { DragOverlay, SortableProvider, type DragEvent } from "@thisbeyond/solid-dnd"
  ...
  return (
    <div class="flex h-full w-full min-w-0 overflow-hidden">
      <div
        ...
        class="w-12 shrink-0 bg-background-base flex flex-col items-center overflow-hidden"
      ...
      >
        <div class="flex-1 min-h-0 w-full flex flex-col items-center">
          ...
          <div class="h-full w-full flex flex-col items-center gap-2 px-2 py-2 overflow-y-auto no-scrollbar">
            {props.renderActions && (
              <div class="shrink-0 w-full flex flex-col items-center gap-1 px-2 pt-2 pb-1">{props.renderActions()}</div>
            )}
